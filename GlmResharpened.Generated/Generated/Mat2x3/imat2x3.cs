...
public struct imat2x3 : IReadOnlyList<int>, IEquatable<imat2x3>
{
    ...
    /// </summary>
    public int Length => (int)Math.Sqrt((((m00*m00 + m01*m01) + m02*m02) + ((m10*m10 + m11*m11) + m12*m12)));
    
    /// <summary>
    /// Returns the squared euclidean length of this matrix.
    /// </summary>
    public int LengthSqr => (((m00*m00 + m01*m01) + m02*m02) + ((m10*m10 + m11*m11) + m12*m12));
    ...
    /// </summary>
    public int Norm => (int)Math.Sqrt((((m00*m00 + m01*m01) + m02*m02) + ((m10*m10 + m11*m11) + m12*m12)));
    
    /// <summary>
    /// Returns the one-norm of this matrix.
    /// </summary>
    public int Norm1 => (((Math.Abs(m00) + Math.Abs(m01)) + Math.Abs(m02)) + ((Math.Abs(m10) + Math.Abs(m11)) + Math.Abs(m12)));
    
    /// <summary>
    /// Returns the two-norm of this matrix.
    /// </summary>
    public int Norm2 => (int)Math.Sqrt((((m00*m00 + m01*m01) + m02*m02) + ((m10*m10 + m11*m11) + m12*m12)));
