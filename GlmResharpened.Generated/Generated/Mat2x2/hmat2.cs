...
public struct hmat2 : IReadOnlyList<Half>, IEquatable<hmat2>
{
    ...
    /// </summary>
    public Half Length => (Half)Math.Sqrt((double)((m00*m00 + m01*m01) + (m10*m10 + m11*m11)));
    
    /// <summary>
    /// Returns the squared euclidean length of this matrix.
    /// </summary>
    public Half LengthSqr => ((m00*m00 + m01*m01) + (m10*m10 + m11*m11));
    ...
    /// </summary>
    public Half Norm => (Half)Math.Sqrt((double)((m00*m00 + m01*m01) + (m10*m10 + m11*m11)));
    
    /// <summary>
    /// Returns the one-norm of this matrix.
    /// </summary>
    public Half Norm1 => ((Half.Abs(m00) + Half.Abs(m01)) + (Half.Abs(m10) + Half.Abs(m11)));
    
    /// <summary>
    /// Returns the two-norm of this matrix.
    /// </summary>
    public Half Norm2 => (Half)Math.Sqrt((double)((m00*m00 + m01*m01) + (m10*m10 + m11*m11)));
