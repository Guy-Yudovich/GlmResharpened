...
public struct cmat2 : IReadOnlyList<Complex>, IEquatable<cmat2>
{
    ...
    /// </summary>
    public Complex Length => (Complex)Math.Sqrt(((m00.LengthSqr() + m01.LengthSqr()) + (m10.LengthSqr() + m11.LengthSqr())));
    
    /// <summary>
    /// Returns the squared euclidean length of this matrix.
    /// </summary>
    public Complex LengthSqr => ((m00.LengthSqr() + m01.LengthSqr()) + (m10.LengthSqr() + m11.LengthSqr()));
    ...
    /// </summary>
    public Complex Norm => (Complex)Math.Sqrt(((m00.LengthSqr() + m01.LengthSqr()) + (m10.LengthSqr() + m11.LengthSqr())));
    
    /// <summary>
    /// Returns the one-norm of this matrix.
    /// </summary>
    public Complex Norm1 => ((m00.Magnitude + m01.Magnitude) + (m10.Magnitude + m11.Magnitude));
    
    /// <summary>
    /// Returns the two-norm of this matrix.
    /// </summary>
    public Complex Norm2 => (Complex)Math.Sqrt(((m00.LengthSqr() + m01.LengthSqr()) + (m10.LengthSqr() + m11.LengthSqr())));
