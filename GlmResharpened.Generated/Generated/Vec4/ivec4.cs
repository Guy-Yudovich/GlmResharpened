...
public struct ivec4 : IReadOnlyList<int>, IEquatable<ivec4>
{
    ...
    /// </summary>
    public int LengthSqr => (int)((x*x + y*y) + (z*z + w*w));
    ...
    /// </summary>
    public int Norm => (int)Math.Sqrt(((x*x + y*y) + (z*z + w*w)));
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public int Norm1 => ((Math.Abs(x) + Math.Abs(y)) + (Math.Abs(z) + Math.Abs(w)));
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public int Norm2 => (int)Math.Sqrt(((x*x + y*y) + (z*z + w*w)));
    
    /// <summary>
    /// Returns the max-norm of this vector.
    /// </summary>
    public int NormMax => Math.Max(Math.Max(Math.Abs(x), Math.Abs(y)), Math.Max(Math.Abs(z), Math.Abs(w)));
    #endregion
    ...
    /// </summary>
    public static int Distance(ivec4 lhs, ivec4 rhs) => (lhs - rhs).Length;
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static int DistanceSqr(ivec4 lhs, ivec4 rhs) => (lhs - rhs).LengthSqr;
