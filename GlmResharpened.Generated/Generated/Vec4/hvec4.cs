...
public struct hvec4 : IReadOnlyList<Half>, IEquatable<hvec4>
{
    ...
    /// </summary>
    public Half Length => (Half)Math.Sqrt((double)((x*x + y*y) + (z*z + w*w)));
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public Half LengthSqr => (Half)((x*x + y*y) + (z*z + w*w));
    ...
    /// </summary>
    public Half Norm => (Half)Math.Sqrt((double)((x*x + y*y) + (z*z + w*w)));
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public Half Norm1 => ((Half.Abs(x) + Half.Abs(y)) + (Half.Abs(z) + Half.Abs(w)));
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public Half Norm2 => (Half)Math.Sqrt((double)((x*x + y*y) + (z*z + w*w)));
    
    /// <summary>
    /// Returns the max-norm of this vector.
    /// </summary>
    public Half NormMax => Half.Max(Half.Max(Half.Abs(x), Half.Abs(y)), Half.Max(Half.Abs(z), Half.Abs(w)));
    ...
    /// </summary>
    public static bool ApproxEqual(hvec4 lhs, hvec4 rhs, float eps = 0.1f) => (float)Distance(lhs, rhs) <= eps;
    ...
    /// </summary>
    public static Half Distance(hvec4 lhs, hvec4 rhs) => (lhs - rhs).Length;
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static Half DistanceSqr(hvec4 lhs, hvec4 rhs) => (lhs - rhs).LengthSqr;
    
    /// <summary>
    /// Calculate the reflection direction for an incident vector (N should be normalized in order to achieve the desired result).
    /// </summary>
    public static hvec4 Reflect(hvec4 I, hvec4 N) => I - (byte)2 * Dot(N, I) * N;
    ...
    {
        var dNI = Dot(N, I);
        var k = (byte)1 - eta * eta * ((byte)1 - dNI * dNI);
        if (k < (byte)0) return Zero;
        return eta * I - (eta * dNI + (Half)Math.Sqrt((double)k)) * N;
    }
    
    /// <summary>
    /// Returns a vector pointing in the same direction as another (faceforward orients a vector to point away from a surface as defined by its normal. If dot(Nref, I) is negative faceforward returns N, otherwise it returns -N).
    /// </summary>
    public static hvec4 FaceForward(hvec4 N, hvec4 I, hvec4 Nref) => Dot(Nref, I) < (byte)0 ? N : -N;
    ...
    /// <summary>
    /// Returns a hvec4 from component-wise application of HermiteInterpolationOrder3 (((byte)3 - (byte)2 * v) * v * v).
    /// </summary>
    public static hvec4 HermiteInterpolationOrder3(hvec4 v) => new hvec4(((byte)3 - (byte)2 * v.x) * v.x * v.x, ((byte)3 - (byte)2 * v.y) * v.y * v.y, ((byte)3 - (byte)2 * v.z) * v.z * v.z, ((byte)3 - (byte)2 * v.w) * v.w * v.w);
    
    /// <summary>
    /// Returns a hvec from the application of HermiteInterpolationOrder3 (((byte)3 - (byte)2 * v) * v * v).
    /// </summary>
    public static hvec4 HermiteInterpolationOrder3(Half v) => new hvec4(((byte)3 - (byte)2 * v) * v * v);
    
    /// <summary>
    /// Returns a hvec4 from component-wise application of HermiteInterpolationOrder5 ((((byte)6 * v - (byte)15) * v + (byte)10) * v * v * v).
    /// </summary>
    public static hvec4 HermiteInterpolationOrder5(hvec4 v) => new hvec4((((byte)6 * v.x - (byte)15) * v.x + (byte)10) * v.x * v.x * v.x, (((byte)6 * v.y - (byte)15) * v.y + (byte)10) * v.y * v.y * v.y, (((byte)6 * v.z - (byte)15) * v.z + (byte)10) * v.z * v.z * v.z, (((byte)6 * v.w - (byte)15) * v.w + (byte)10) * v.w * v.w * v.w);
    
    /// <summary>
    /// Returns a hvec from the application of HermiteInterpolationOrder5 ((((byte)6 * v - (byte)15) * v + (byte)10) * v * v * v).
    /// </summary>
    public static hvec4 HermiteInterpolationOrder5(Half v) => new hvec4((((byte)6 * v - (byte)15) * v + (byte)10) * v * v * v);
    ...
    /// <summary>
    /// Returns a ivec4 from component-wise application of Sign (Math.Sign((double)v)).
    /// </summary>
    public static ivec4 Sign(hvec4 v) => new ivec4(Math.Sign((double)v.x), Math.Sign((double)v.y), Math.Sign((double)v.z), Math.Sign((double)v.w));
    
    /// <summary>
    /// Returns a ivec from the application of Sign (Math.Sign((double)v)).
    /// </summary>
    public static ivec4 Sign(Half v) => new ivec4(Math.Sign((double)v));
    ...
    /// <summary>
    /// Returns a hvec4 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec4 Mix(hvec4 min, hvec4 max, hvec4 a) => new hvec4(min.x * ((byte)1-a.x) + max.x * a.x, min.y * ((byte)1-a.y) + max.y * a.y, min.z * ((byte)1-a.z) + max.z * a.z, min.w * ((byte)1-a.w) + max.w * a.w);
    
    /// <summary>
    /// Returns a hvec4 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec4 Mix(hvec4 min, hvec4 max, Half a) => new hvec4(min.x * ((byte)1-a) + max.x * a, min.y * ((byte)1-a) + max.y * a, min.z * ((byte)1-a) + max.z * a, min.w * ((byte)1-a) + max.w * a);
    
    /// <summary>
    /// Returns a hvec4 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec4 Mix(hvec4 min, Half max, hvec4 a) => new hvec4(min.x * ((byte)1-a.x) + max * a.x, min.y * ((byte)1-a.y) + max * a.y, min.z * ((byte)1-a.z) + max * a.z, min.w * ((byte)1-a.w) + max * a.w);
    
    /// <summary>
    /// Returns a hvec4 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec4 Mix(hvec4 min, Half max, Half a) => new hvec4(min.x * ((byte)1-a) + max * a, min.y * ((byte)1-a) + max * a, min.z * ((byte)1-a) + max * a, min.w * ((byte)1-a) + max * a);
    
    /// <summary>
    /// Returns a hvec4 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec4 Mix(Half min, hvec4 max, hvec4 a) => new hvec4(min * ((byte)1-a.x) + max.x * a.x, min * ((byte)1-a.y) + max.y * a.y, min * ((byte)1-a.z) + max.z * a.z, min * ((byte)1-a.w) + max.w * a.w);
    
    /// <summary>
    /// Returns a hvec4 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec4 Mix(Half min, hvec4 max, Half a) => new hvec4(min * ((byte)1-a) + max.x * a, min * ((byte)1-a) + max.y * a, min * ((byte)1-a) + max.z * a, min * ((byte)1-a) + max.w * a);
    
    /// <summary>
    /// Returns a hvec4 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec4 Mix(Half min, Half max, hvec4 a) => new hvec4(min * ((byte)1-a.x) + max * a.x, min * ((byte)1-a.y) + max * a.y, min * ((byte)1-a.z) + max * a.z, min * ((byte)1-a.w) + max * a.w);
    
    /// <summary>
    /// Returns a hvec from the application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec4 Mix(Half min, Half max, Half a) => new hvec4(min * ((byte)1-a) + max * a);
    
    /// <summary>
    /// Returns a hvec4 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec4 Lerp(hvec4 min, hvec4 max, hvec4 a) => new hvec4(min.x * ((byte)1-a.x) + max.x * a.x, min.y * ((byte)1-a.y) + max.y * a.y, min.z * ((byte)1-a.z) + max.z * a.z, min.w * ((byte)1-a.w) + max.w * a.w);
    
    /// <summary>
    /// Returns a hvec4 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec4 Lerp(hvec4 min, hvec4 max, Half a) => new hvec4(min.x * ((byte)1-a) + max.x * a, min.y * ((byte)1-a) + max.y * a, min.z * ((byte)1-a) + max.z * a, min.w * ((byte)1-a) + max.w * a);
    
    /// <summary>
    /// Returns a hvec4 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec4 Lerp(hvec4 min, Half max, hvec4 a) => new hvec4(min.x * ((byte)1-a.x) + max * a.x, min.y * ((byte)1-a.y) + max * a.y, min.z * ((byte)1-a.z) + max * a.z, min.w * ((byte)1-a.w) + max * a.w);
    
    /// <summary>
    /// Returns a hvec4 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec4 Lerp(hvec4 min, Half max, Half a) => new hvec4(min.x * ((byte)1-a) + max * a, min.y * ((byte)1-a) + max * a, min.z * ((byte)1-a) + max * a, min.w * ((byte)1-a) + max * a);
    
    /// <summary>
    /// Returns a hvec4 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec4 Lerp(Half min, hvec4 max, hvec4 a) => new hvec4(min * ((byte)1-a.x) + max.x * a.x, min * ((byte)1-a.y) + max.y * a.y, min * ((byte)1-a.z) + max.z * a.z, min * ((byte)1-a.w) + max.w * a.w);
    
    /// <summary>
    /// Returns a hvec4 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec4 Lerp(Half min, hvec4 max, Half a) => new hvec4(min * ((byte)1-a) + max.x * a, min * ((byte)1-a) + max.y * a, min * ((byte)1-a) + max.z * a, min * ((byte)1-a) + max.w * a);
    
    /// <summary>
    /// Returns a hvec4 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec4 Lerp(Half min, Half max, hvec4 a) => new hvec4(min * ((byte)1-a.x) + max * a.x, min * ((byte)1-a.y) + max * a.y, min * ((byte)1-a.z) + max * a.z, min * ((byte)1-a.w) + max * a.w);
    
    /// <summary>
    /// Returns a hvec from the application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec4 Lerp(Half min, Half max, Half a) => new hvec4(min * ((byte)1-a) + max * a);
    ...
    /// </summary>
    public static hvec4 Degrees(hvec4 v) => new hvec4((Half)(v.x * ((Half)(57.295779513082320876798154814105170332405472466564321))), (Half)(v.y * ((Half)(57.295779513082320876798154814105170332405472466564321))), (Half)(v.z * ((Half)(57.295779513082320876798154814105170332405472466564321))), (Half)(v.w * ((Half)(57.295779513082320876798154814105170332405472466564321))));
    
    /// <summary>
    /// Returns a hvec from the application of Degrees (Radians-To-Degrees Conversion).
    /// </summary>
    public static hvec4 Degrees(Half v) => new hvec4((Half)(v * ((Half)(57.295779513082320876798154814105170332405472466564321))));
    
    /// <summary>
    /// Returns a hvec4 from component-wise application of Radians (Degrees-To-Radians Conversion).
    /// </summary>
    public static hvec4 Radians(hvec4 v) => new hvec4((Half)(v.x * ((Half)(0.0174532925199432957692369076848861271344287188854172))), (Half)(v.y * ((Half)(0.0174532925199432957692369076848861271344287188854172))), (Half)(v.z * ((Half)(0.0174532925199432957692369076848861271344287188854172))), (Half)(v.w * ((Half)(0.0174532925199432957692369076848861271344287188854172))));
    
    /// <summary>
    /// Returns a hvec from the application of Radians (Degrees-To-Radians Conversion).
    /// </summary>
    public static hvec4 Radians(Half v) => new hvec4((Half)(v * ((Half)(0.0174532925199432957692369076848861271344287188854172))));
    ...
    /// <summary>
    /// Returns a hvec4 from component-wise application of Floor ((Half)Math.Floor((double)v)).
    /// </summary>
    public static hvec4 Floor(hvec4 v) => new hvec4((Half)Math.Floor((double)v.x), (Half)Math.Floor((double)v.y), (Half)Math.Floor((double)v.z), (Half)Math.Floor((double)v.w));
    
    /// <summary>
    /// Returns a hvec from the application of Floor ((Half)Math.Floor((double)v)).
    /// </summary>
    public static hvec4 Floor(Half v) => new hvec4((Half)Math.Floor((double)v));
    
    /// <summary>
    /// Returns a hvec4 from component-wise application of Ceiling ((Half)Math.Ceiling((double)v)).
    /// </summary>
    public static hvec4 Ceiling(hvec4 v) => new hvec4((Half)Math.Ceiling((double)v.x), (Half)Math.Ceiling((double)v.y), (Half)Math.Ceiling((double)v.z), (Half)Math.Ceiling((double)v.w));
    
    /// <summary>
    /// Returns a hvec from the application of Ceiling ((Half)Math.Ceiling((double)v)).
    /// </summary>
    public static hvec4 Ceiling(Half v) => new hvec4((Half)Math.Ceiling((double)v));
    
    /// <summary>
    /// Returns a hvec4 from component-wise application of Round ((Half)Math.Round((double)v)).
    /// </summary>
    public static hvec4 Round(hvec4 v) => new hvec4((Half)Math.Round((double)v.x), (Half)Math.Round((double)v.y), (Half)Math.Round((double)v.z), (Half)Math.Round((double)v.w));
    
    /// <summary>
    /// Returns a hvec from the application of Round ((Half)Math.Round((double)v)).
    /// </summary>
    public static hvec4 Round(Half v) => new hvec4((Half)Math.Round((double)v));
    ...
    /// <summary>
    /// Returns a hvec4 from component-wise application of Fract ((v - (Half)Math.Floor((double)v))).
    /// </summary>
    public static hvec4 Fract(hvec4 v) => new hvec4((v.x - (Half)Math.Floor((double)v.x)), (v.y - (Half)Math.Floor((double)v.y)), (v.z - (Half)Math.Floor((double)v.z)), (v.w - (Half)Math.Floor((double)v.w)));
    
    /// <summary>
    /// Returns a hvec from the application of Fract ((v - (Half)Math.Floor((double)v))).
    /// </summary>
    public static hvec4 Fract(Half v) => new hvec4((v - (Half)Math.Floor((double)v)));
    
    /// <summary>
    /// Returns a hvec4 from component-wise application of Trunc ((Half)(long)(v)).
    /// </summary>
    public static hvec4 Trunc(hvec4 v) => new hvec4((Half)(long)(v.x), (Half)(long)(v.y), (Half)(long)(v.z), (Half)(long)(v.w));
    
    /// <summary>
    /// Returns a hvec from the application of Trunc ((Half)(long)(v)).
    /// </summary>
    public static hvec4 Trunc(Half v) => new hvec4((Half)(long)(v));
