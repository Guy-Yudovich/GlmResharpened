...
public struct decvec4 : IReadOnlyList<decimal>, IEquatable<decvec4>
{
    ...
    /// </summary>
    public decimal LengthSqr => (decimal)((x*x + y*y) + (z*z + w*w));
    ...
    /// </summary>
    public static bool ApproxEqual(decvec4 lhs, decvec4 rhs, decimal eps = 0.1m) => (decimal)Distance(lhs, rhs) <= eps;
    ...
    /// <summary>
    /// Returns a decvec4 from component-wise application of Floor ((decimal)Math.Floor((double)v)).
    /// </summary>
    public static decvec4 Floor(decvec4 v) => new decvec4((decimal)Math.Floor((double)v.x), (decimal)Math.Floor((double)v.y), (decimal)Math.Floor((double)v.z), (decimal)Math.Floor((double)v.w));
    
    /// <summary>
    /// Returns a decvec from the application of Floor ((decimal)Math.Floor((double)v)).
    /// </summary>
    public static decvec4 Floor(decimal v) => new decvec4((decimal)Math.Floor((double)v));
    
    /// <summary>
    /// Returns a decvec4 from component-wise application of Ceiling ((decimal)Math.Ceiling((double)v)).
    /// </summary>
    public static decvec4 Ceiling(decvec4 v) => new decvec4((decimal)Math.Ceiling((double)v.x), (decimal)Math.Ceiling((double)v.y), (decimal)Math.Ceiling((double)v.z), (decimal)Math.Ceiling((double)v.w));
    
    /// <summary>
    /// Returns a decvec from the application of Ceiling ((decimal)Math.Ceiling((double)v)).
    /// </summary>
    public static decvec4 Ceiling(decimal v) => new decvec4((decimal)Math.Ceiling((double)v));
    
    /// <summary>
    /// Returns a decvec4 from component-wise application of Round ((decimal)Math.Round((double)v)).
    /// </summary>
    public static decvec4 Round(decvec4 v) => new decvec4((decimal)Math.Round((double)v.x), (decimal)Math.Round((double)v.y), (decimal)Math.Round((double)v.z), (decimal)Math.Round((double)v.w));
    
    /// <summary>
    /// Returns a decvec from the application of Round ((decimal)Math.Round((double)v)).
    /// </summary>
    public static decvec4 Round(decimal v) => new decvec4((decimal)Math.Round((double)v));
    ...
    /// <summary>
    /// Returns a decvec4 from component-wise application of Fract ((v - (decimal)Math.Floor((double)v))).
    /// </summary>
    public static decvec4 Fract(decvec4 v) => new decvec4((v.x - (decimal)Math.Floor((double)v.x)), (v.y - (decimal)Math.Floor((double)v.y)), (v.z - (decimal)Math.Floor((double)v.z)), (v.w - (decimal)Math.Floor((double)v.w)));
    
    /// <summary>
    /// Returns a decvec from the application of Fract ((v - (decimal)Math.Floor((double)v))).
    /// </summary>
    public static decvec4 Fract(decimal v) => new decvec4((v - (decimal)Math.Floor((double)v)));
    
    /// <summary>
    /// Returns a decvec4 from component-wise application of Trunc ((decimal)(long)(v)).
    /// </summary>
    public static decvec4 Trunc(decvec4 v) => new decvec4((decimal)(long)(v.x), (decimal)(long)(v.y), (decimal)(long)(v.z), (decimal)(long)(v.w));
    
    /// <summary>
    /// Returns a decvec from the application of Trunc ((decimal)(long)(v)).
    /// </summary>
    public static decvec4 Trunc(decimal v) => new decvec4((decimal)(long)(v));
