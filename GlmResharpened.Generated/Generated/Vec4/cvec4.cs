...
public struct cvec4 : IReadOnlyList<Complex>, IEquatable<cvec4>
{
    ...
    /// </summary>
    public Complex Length => (Complex)Math.Sqrt(((x.LengthSqr() + y.LengthSqr()) + (z.LengthSqr() + w.LengthSqr())));
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public Complex LengthSqr => (Complex)((x.LengthSqr() + y.LengthSqr()) + (z.LengthSqr() + w.LengthSqr()));
    ...
    /// </summary>
    public Complex Norm => (Complex)Math.Sqrt(((x.LengthSqr() + y.LengthSqr()) + (z.LengthSqr() + w.LengthSqr())));
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public Complex Norm1 => ((x.Magnitude + y.Magnitude) + (z.Magnitude + w.Magnitude));
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public Complex Norm2 => (Complex)Math.Sqrt(((x.LengthSqr() + y.LengthSqr()) + (z.LengthSqr() + w.LengthSqr())));
    
    /// <summary>
    /// Returns the max-norm of this vector.
    /// </summary>
    public Complex NormMax => Math.Max(Math.Max(x.Magnitude, y.Magnitude), Math.Max(z.Magnitude, w.Magnitude));
    ...
    /// </summary>
    public static Complex Distance(cvec4 lhs, cvec4 rhs) => (lhs - rhs).Length;
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static Complex DistanceSqr(cvec4 lhs, cvec4 rhs) => (lhs - rhs).LengthSqr;
    ...
    /// </summary>
    public static bvec4 operator ==(cvec4 lhs, cvec4 rhs) => new bvec4(lhs.x == rhs.x, lhs.y == rhs.y, lhs.z == rhs.z, lhs.w == rhs.w);
    
    /// <summary>
    /// Returns a bvec4 from component-wise application of operator == (lhs == rhs).
    /// </summary>
    public static bvec4 operator ==(cvec4 lhs, Complex rhs) => new bvec4(lhs.x == rhs, lhs.y == rhs, lhs.z == rhs, lhs.w == rhs);
    
    /// <summary>
    /// Returns a bvec4 from component-wise application of operator == (lhs == rhs).
    /// </summary>
    public static bvec4 operator ==(Complex lhs, cvec4 rhs) => new bvec4(lhs == rhs.x, lhs == rhs.y, lhs == rhs.z, lhs == rhs.w);
