...
public static partial class glm
{
    ...
    /// </summary>
    public static long Length(lvec4 v) => v.Length;
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public static long LengthSqr(lvec4 v) => v.LengthSqr;
    ...
    /// </summary>
    public static long Norm(lvec4 v) => v.Norm;
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public static long Norm1(lvec4 v) => v.Norm1;
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public static long Norm2(lvec4 v) => v.Norm2;
    
    /// <summary>
    /// Returns the max-norm of this vector.
    /// </summary>
    public static long NormMax(lvec4 v) => v.NormMax;
    ...
    /// </summary>
    public static long Distance(lvec4 lhs, lvec4 rhs) => lvec4.Distance(lhs, rhs);
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static long DistanceSqr(lvec4 lhs, lvec4 rhs) => lvec4.DistanceSqr(lhs, rhs);
