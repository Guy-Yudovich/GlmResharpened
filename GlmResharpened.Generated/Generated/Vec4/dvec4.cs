...
public struct dvec4 : IReadOnlyList<double>, IEquatable<dvec4>
{
    ...
    /// </summary>
    public double LengthSqr => (double)((x*x + y*y) + (z*z + w*w));
    ...
    /// </summary>
    public static bool ApproxEqual(dvec4 lhs, dvec4 rhs, double eps = 0.1d) => (double)Distance(lhs, rhs) <= eps;
    ...
    /// <summary>
    /// Returns a dvec4 from component-wise application of Floor ((double)Math.Floor((double)v)).
    /// </summary>
    public static dvec4 Floor(dvec4 v) => new dvec4((double)Math.Floor((double)v.x), (double)Math.Floor((double)v.y), (double)Math.Floor((double)v.z), (double)Math.Floor((double)v.w));
    
    /// <summary>
    /// Returns a dvec from the application of Floor ((double)Math.Floor((double)v)).
    /// </summary>
    public static dvec4 Floor(double v) => new dvec4((double)Math.Floor((double)v));
    
    /// <summary>
    /// Returns a dvec4 from component-wise application of Ceiling ((double)Math.Ceiling((double)v)).
    /// </summary>
    public static dvec4 Ceiling(dvec4 v) => new dvec4((double)Math.Ceiling((double)v.x), (double)Math.Ceiling((double)v.y), (double)Math.Ceiling((double)v.z), (double)Math.Ceiling((double)v.w));
    
    /// <summary>
    /// Returns a dvec from the application of Ceiling ((double)Math.Ceiling((double)v)).
    /// </summary>
    public static dvec4 Ceiling(double v) => new dvec4((double)Math.Ceiling((double)v));
    
    /// <summary>
    /// Returns a dvec4 from component-wise application of Round ((double)Math.Round((double)v)).
    /// </summary>
    public static dvec4 Round(dvec4 v) => new dvec4((double)Math.Round((double)v.x), (double)Math.Round((double)v.y), (double)Math.Round((double)v.z), (double)Math.Round((double)v.w));
    
    /// <summary>
    /// Returns a dvec from the application of Round ((double)Math.Round((double)v)).
    /// </summary>
    public static dvec4 Round(double v) => new dvec4((double)Math.Round((double)v));
    ...
    /// <summary>
    /// Returns a dvec4 from component-wise application of Fract ((v - (double)Math.Floor((double)v))).
    /// </summary>
    public static dvec4 Fract(dvec4 v) => new dvec4((v.x - (double)Math.Floor((double)v.x)), (v.y - (double)Math.Floor((double)v.y)), (v.z - (double)Math.Floor((double)v.z)), (v.w - (double)Math.Floor((double)v.w)));
    
    /// <summary>
    /// Returns a dvec from the application of Fract ((v - (double)Math.Floor((double)v))).
    /// </summary>
    public static dvec4 Fract(double v) => new dvec4((v - (double)Math.Floor((double)v)));
    
    /// <summary>
    /// Returns a dvec4 from component-wise application of Trunc ((double)(long)(v)).
    /// </summary>
    public static dvec4 Trunc(dvec4 v) => new dvec4((double)(long)(v.x), (double)(long)(v.y), (double)(long)(v.z), (double)(long)(v.w));
    
    /// <summary>
    /// Returns a dvec from the application of Trunc ((double)(long)(v)).
    /// </summary>
    public static dvec4 Trunc(double v) => new dvec4((double)(long)(v));
