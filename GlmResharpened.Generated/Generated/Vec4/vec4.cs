...
public struct vec4 : IReadOnlyList<float>, IEquatable<vec4>
{
    ...
    /// </summary>
    public float LengthSqr => (float)((x*x + y*y) + (z*z + w*w));
    ...
    /// </summary>
    public static bool ApproxEqual(vec4 lhs, vec4 rhs, float eps = 0.1f) => (float)Distance(lhs, rhs) <= eps;
    ...
    /// <summary>
    /// Returns a vec4 from component-wise application of Floor ((float)Math.Floor((double)v)).
    /// </summary>
    public static vec4 Floor(vec4 v) => new vec4((float)Math.Floor((double)v.x), (float)Math.Floor((double)v.y), (float)Math.Floor((double)v.z), (float)Math.Floor((double)v.w));
    
    /// <summary>
    /// Returns a vec from the application of Floor ((float)Math.Floor((double)v)).
    /// </summary>
    public static vec4 Floor(float v) => new vec4((float)Math.Floor((double)v));
    
    /// <summary>
    /// Returns a vec4 from component-wise application of Ceiling ((float)Math.Ceiling((double)v)).
    /// </summary>
    public static vec4 Ceiling(vec4 v) => new vec4((float)Math.Ceiling((double)v.x), (float)Math.Ceiling((double)v.y), (float)Math.Ceiling((double)v.z), (float)Math.Ceiling((double)v.w));
    
    /// <summary>
    /// Returns a vec from the application of Ceiling ((float)Math.Ceiling((double)v)).
    /// </summary>
    public static vec4 Ceiling(float v) => new vec4((float)Math.Ceiling((double)v));
    
    /// <summary>
    /// Returns a vec4 from component-wise application of Round ((float)Math.Round((double)v)).
    /// </summary>
    public static vec4 Round(vec4 v) => new vec4((float)Math.Round((double)v.x), (float)Math.Round((double)v.y), (float)Math.Round((double)v.z), (float)Math.Round((double)v.w));
    
    /// <summary>
    /// Returns a vec from the application of Round ((float)Math.Round((double)v)).
    /// </summary>
    public static vec4 Round(float v) => new vec4((float)Math.Round((double)v));
    ...
    /// <summary>
    /// Returns a vec4 from component-wise application of Fract ((v - (float)Math.Floor((double)v))).
    /// </summary>
    public static vec4 Fract(vec4 v) => new vec4((v.x - (float)Math.Floor((double)v.x)), (v.y - (float)Math.Floor((double)v.y)), (v.z - (float)Math.Floor((double)v.z)), (v.w - (float)Math.Floor((double)v.w)));
    
    /// <summary>
    /// Returns a vec from the application of Fract ((v - (float)Math.Floor((double)v))).
    /// </summary>
    public static vec4 Fract(float v) => new vec4((v - (float)Math.Floor((double)v)));
    
    /// <summary>
    /// Returns a vec4 from component-wise application of Trunc ((float)(long)(v)).
    /// </summary>
    public static vec4 Trunc(vec4 v) => new vec4((float)(long)(v.x), (float)(long)(v.y), (float)(long)(v.z), (float)(long)(v.w));
    
    /// <summary>
    /// Returns a vec from the application of Trunc ((float)(long)(v)).
    /// </summary>
    public static vec4 Trunc(float v) => new vec4((float)(long)(v));
