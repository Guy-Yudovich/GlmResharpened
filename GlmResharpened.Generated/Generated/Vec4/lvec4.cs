...
public struct lvec4 : IReadOnlyList<long>, IEquatable<lvec4>
{
    ...
    /// </summary>
    public long Length => (long)Math.Sqrt(((x*x + y*y) + (z*z + w*w)));
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public long LengthSqr => (long)((x*x + y*y) + (z*z + w*w));
    ...
    /// </summary>
    public long Norm => (long)Math.Sqrt(((x*x + y*y) + (z*z + w*w)));
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public long Norm1 => ((Math.Abs(x) + Math.Abs(y)) + (Math.Abs(z) + Math.Abs(w)));
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public long Norm2 => (long)Math.Sqrt(((x*x + y*y) + (z*z + w*w)));
    
    /// <summary>
    /// Returns the max-norm of this vector.
    /// </summary>
    public long NormMax => Math.Max(Math.Max(Math.Abs(x), Math.Abs(y)), Math.Max(Math.Abs(z), Math.Abs(w)));
    #endregion
    ...
    /// </summary>
    public static long Distance(lvec4 lhs, lvec4 rhs) => (lhs - rhs).Length;
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static long DistanceSqr(lvec4 lhs, lvec4 rhs) => (lhs - rhs).LengthSqr;
