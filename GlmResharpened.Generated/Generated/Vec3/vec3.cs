...
public struct vec3 : IReadOnlyList<float>, IEquatable<vec3>
{
    ...
    /// </summary>
    public float LengthSqr => (float)((x*x + y*y) + z*z);
    ...
    /// </summary>
    public vec3 NormalizedSafe => (this == Zero).AllTrue ? Zero : this / (float)Length;
    #endregion
    ...
    /// </summary>
    public static bool ApproxEqual(vec3 lhs, vec3 rhs, float eps = 0.1f) => (float)Distance(lhs, rhs) <= eps;
    ...
    /// <summary>
    /// Returns a vec3 from component-wise application of Floor ((float)Math.Floor((double)v)).
    /// </summary>
    public static vec3 Floor(vec3 v) => new vec3((float)Math.Floor((double)v.x), (float)Math.Floor((double)v.y), (float)Math.Floor((double)v.z));
    
    /// <summary>
    /// Returns a vec from the application of Floor ((float)Math.Floor((double)v)).
    /// </summary>
    public static vec3 Floor(float v) => new vec3((float)Math.Floor((double)v));
    
    /// <summary>
    /// Returns a vec3 from component-wise application of Ceiling ((float)Math.Ceiling((double)v)).
    /// </summary>
    public static vec3 Ceiling(vec3 v) => new vec3((float)Math.Ceiling((double)v.x), (float)Math.Ceiling((double)v.y), (float)Math.Ceiling((double)v.z));
    
    /// <summary>
    /// Returns a vec from the application of Ceiling ((float)Math.Ceiling((double)v)).
    /// </summary>
    public static vec3 Ceiling(float v) => new vec3((float)Math.Ceiling((double)v));
    
    /// <summary>
    /// Returns a vec3 from component-wise application of Round ((float)Math.Round((double)v)).
    /// </summary>
    public static vec3 Round(vec3 v) => new vec3((float)Math.Round((double)v.x), (float)Math.Round((double)v.y), (float)Math.Round((double)v.z));
    
    /// <summary>
    /// Returns a vec from the application of Round ((float)Math.Round((double)v)).
    /// </summary>
    public static vec3 Round(float v) => new vec3((float)Math.Round((double)v));
    ...
    /// <summary>
    /// Returns a vec3 from component-wise application of Fract ((v - (float)Math.Floor((double)v))).
    /// </summary>
    public static vec3 Fract(vec3 v) => new vec3((v.x - (float)Math.Floor((double)v.x)), (v.y - (float)Math.Floor((double)v.y)), (v.z - (float)Math.Floor((double)v.z)));
    
    /// <summary>
    /// Returns a vec from the application of Fract ((v - (float)Math.Floor((double)v))).
    /// </summary>
    public static vec3 Fract(float v) => new vec3((v - (float)Math.Floor((double)v)));
    
    /// <summary>
    /// Returns a vec3 from component-wise application of Trunc ((float)(long)(v)).
    /// </summary>
    public static vec3 Trunc(vec3 v) => new vec3((float)(long)(v.x), (float)(long)(v.y), (float)(long)(v.z));
    
    /// <summary>
    /// Returns a vec from the application of Trunc ((float)(long)(v)).
    /// </summary>
    public static vec3 Trunc(float v) => new vec3((float)(long)(v));
