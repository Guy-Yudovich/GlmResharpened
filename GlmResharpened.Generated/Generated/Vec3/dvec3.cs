...
public struct dvec3 : IReadOnlyList<double>, IEquatable<dvec3>
{
    ...
    /// </summary>
    public double LengthSqr => (double)((x*x + y*y) + z*z);
    ...
    /// </summary>
    public dvec3 NormalizedSafe => (this == Zero).AllTrue ? Zero : this / (double)Length;
    #endregion
    ...
    /// </summary>
    public static bool ApproxEqual(dvec3 lhs, dvec3 rhs, double eps = 0.1d) => (double)Distance(lhs, rhs) <= eps;
    ...
    /// <summary>
    /// Returns a dvec3 from component-wise application of Floor ((double)Math.Floor((double)v)).
    /// </summary>
    public static dvec3 Floor(dvec3 v) => new dvec3((double)Math.Floor((double)v.x), (double)Math.Floor((double)v.y), (double)Math.Floor((double)v.z));
    
    /// <summary>
    /// Returns a dvec from the application of Floor ((double)Math.Floor((double)v)).
    /// </summary>
    public static dvec3 Floor(double v) => new dvec3((double)Math.Floor((double)v));
    
    /// <summary>
    /// Returns a dvec3 from component-wise application of Ceiling ((double)Math.Ceiling((double)v)).
    /// </summary>
    public static dvec3 Ceiling(dvec3 v) => new dvec3((double)Math.Ceiling((double)v.x), (double)Math.Ceiling((double)v.y), (double)Math.Ceiling((double)v.z));
    
    /// <summary>
    /// Returns a dvec from the application of Ceiling ((double)Math.Ceiling((double)v)).
    /// </summary>
    public static dvec3 Ceiling(double v) => new dvec3((double)Math.Ceiling((double)v));
    
    /// <summary>
    /// Returns a dvec3 from component-wise application of Round ((double)Math.Round((double)v)).
    /// </summary>
    public static dvec3 Round(dvec3 v) => new dvec3((double)Math.Round((double)v.x), (double)Math.Round((double)v.y), (double)Math.Round((double)v.z));
    
    /// <summary>
    /// Returns a dvec from the application of Round ((double)Math.Round((double)v)).
    /// </summary>
    public static dvec3 Round(double v) => new dvec3((double)Math.Round((double)v));
    ...
    /// <summary>
    /// Returns a dvec3 from component-wise application of Fract ((v - (double)Math.Floor((double)v))).
    /// </summary>
    public static dvec3 Fract(dvec3 v) => new dvec3((v.x - (double)Math.Floor((double)v.x)), (v.y - (double)Math.Floor((double)v.y)), (v.z - (double)Math.Floor((double)v.z)));
    
    /// <summary>
    /// Returns a dvec from the application of Fract ((v - (double)Math.Floor((double)v))).
    /// </summary>
    public static dvec3 Fract(double v) => new dvec3((v - (double)Math.Floor((double)v)));
    
    /// <summary>
    /// Returns a dvec3 from component-wise application of Trunc ((double)(long)(v)).
    /// </summary>
    public static dvec3 Trunc(dvec3 v) => new dvec3((double)(long)(v.x), (double)(long)(v.y), (double)(long)(v.z));
    
    /// <summary>
    /// Returns a dvec from the application of Trunc ((double)(long)(v)).
    /// </summary>
    public static dvec3 Trunc(double v) => new dvec3((double)(long)(v));
