...
public struct uvec3 : IReadOnlyList<uint>, IEquatable<uvec3>
{
    ...
    /// </summary>
    public uint Length => (uint)Math.Sqrt(((x*x + y*y) + z*z));
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public uint LengthSqr => (uint)((x*x + y*y) + z*z);
    ...
    /// </summary>
    public uint Norm => (uint)Math.Sqrt(((x*x + y*y) + z*z));
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public uint Norm1 => ((x + y) + z);
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public uint Norm2 => (uint)Math.Sqrt(((x*x + y*y) + z*z));
    ...
    /// </summary>
    public static uint Distance(uvec3 lhs, uvec3 rhs) => (lhs - rhs).Length;
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static uint DistanceSqr(uvec3 lhs, uvec3 rhs) => (lhs - rhs).LengthSqr;
