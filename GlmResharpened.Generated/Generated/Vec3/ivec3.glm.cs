...
public static partial class glm
{
    ...
    /// </summary>
    public static int Length(ivec3 v) => v.Length;
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public static int LengthSqr(ivec3 v) => v.LengthSqr;
    ...
    /// </summary>
    public static int Norm(ivec3 v) => v.Norm;
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public static int Norm1(ivec3 v) => v.Norm1;
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public static int Norm2(ivec3 v) => v.Norm2;
    
    /// <summary>
    /// Returns the max-norm of this vector.
    /// </summary>
    public static int NormMax(ivec3 v) => v.NormMax;
    ...
    /// </summary>
    public static int Distance(ivec3 lhs, ivec3 rhs) => ivec3.Distance(lhs, rhs);
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static int DistanceSqr(ivec3 lhs, ivec3 rhs) => ivec3.DistanceSqr(lhs, rhs);
