...
public struct decvec3 : IReadOnlyList<decimal>, IEquatable<decvec3>
{
    ...
    /// </summary>
    public decimal LengthSqr => (decimal)((x*x + y*y) + z*z);
    ...
    /// </summary>
    public static bool ApproxEqual(decvec3 lhs, decvec3 rhs, decimal eps = 0.1m) => (decimal)Distance(lhs, rhs) <= eps;
    ...
    /// <summary>
    /// Returns a decvec3 from component-wise application of Floor ((decimal)Math.Floor((double)v)).
    /// </summary>
    public static decvec3 Floor(decvec3 v) => new decvec3((decimal)Math.Floor((double)v.x), (decimal)Math.Floor((double)v.y), (decimal)Math.Floor((double)v.z));
    
    /// <summary>
    /// Returns a decvec from the application of Floor ((decimal)Math.Floor((double)v)).
    /// </summary>
    public static decvec3 Floor(decimal v) => new decvec3((decimal)Math.Floor((double)v));
    
    /// <summary>
    /// Returns a decvec3 from component-wise application of Ceiling ((decimal)Math.Ceiling((double)v)).
    /// </summary>
    public static decvec3 Ceiling(decvec3 v) => new decvec3((decimal)Math.Ceiling((double)v.x), (decimal)Math.Ceiling((double)v.y), (decimal)Math.Ceiling((double)v.z));
    
    /// <summary>
    /// Returns a decvec from the application of Ceiling ((decimal)Math.Ceiling((double)v)).
    /// </summary>
    public static decvec3 Ceiling(decimal v) => new decvec3((decimal)Math.Ceiling((double)v));
    
    /// <summary>
    /// Returns a decvec3 from component-wise application of Round ((decimal)Math.Round((double)v)).
    /// </summary>
    public static decvec3 Round(decvec3 v) => new decvec3((decimal)Math.Round((double)v.x), (decimal)Math.Round((double)v.y), (decimal)Math.Round((double)v.z));
    
    /// <summary>
    /// Returns a decvec from the application of Round ((decimal)Math.Round((double)v)).
    /// </summary>
    public static decvec3 Round(decimal v) => new decvec3((decimal)Math.Round((double)v));
    ...
    /// <summary>
    /// Returns a decvec3 from component-wise application of Fract ((v - (decimal)Math.Floor((double)v))).
    /// </summary>
    public static decvec3 Fract(decvec3 v) => new decvec3((v.x - (decimal)Math.Floor((double)v.x)), (v.y - (decimal)Math.Floor((double)v.y)), (v.z - (decimal)Math.Floor((double)v.z)));
    
    /// <summary>
    /// Returns a decvec from the application of Fract ((v - (decimal)Math.Floor((double)v))).
    /// </summary>
    public static decvec3 Fract(decimal v) => new decvec3((v - (decimal)Math.Floor((double)v)));
    
    /// <summary>
    /// Returns a decvec3 from component-wise application of Trunc ((decimal)(long)(v)).
    /// </summary>
    public static decvec3 Trunc(decvec3 v) => new decvec3((decimal)(long)(v.x), (decimal)(long)(v.y), (decimal)(long)(v.z));
    
    /// <summary>
    /// Returns a decvec from the application of Trunc ((decimal)(long)(v)).
    /// </summary>
    public static decvec3 Trunc(decimal v) => new decvec3((decimal)(long)(v));
