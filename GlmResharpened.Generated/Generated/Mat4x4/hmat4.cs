...
public struct hmat4 : IReadOnlyList<Half>, IEquatable<hmat4>
{
    ...
    /// </summary>
    public Half Length => (Half)Math.Sqrt((double)((((m00*m00 + m01*m01) + (m02*m02 + m03*m03)) + ((m10*m10 + m11*m11) + (m12*m12 + m13*m13))) + (((m20*m20 + m21*m21) + (m22*m22 + m23*m23)) + ((m30*m30 + m31*m31) + (m32*m32 + m33*m33)))));
    
    /// <summary>
    /// Returns the squared euclidean length of this matrix.
    /// </summary>
    public Half LengthSqr => ((((m00*m00 + m01*m01) + (m02*m02 + m03*m03)) + ((m10*m10 + m11*m11) + (m12*m12 + m13*m13))) + (((m20*m20 + m21*m21) + (m22*m22 + m23*m23)) + ((m30*m30 + m31*m31) + (m32*m32 + m33*m33))));
    ...
    /// </summary>
    public Half Norm => (Half)Math.Sqrt((double)((((m00*m00 + m01*m01) + (m02*m02 + m03*m03)) + ((m10*m10 + m11*m11) + (m12*m12 + m13*m13))) + (((m20*m20 + m21*m21) + (m22*m22 + m23*m23)) + ((m30*m30 + m31*m31) + (m32*m32 + m33*m33)))));
    
    /// <summary>
    /// Returns the one-norm of this matrix.
    /// </summary>
    public Half Norm1 => ((((Half.Abs(m00) + Half.Abs(m01)) + (Half.Abs(m02) + Half.Abs(m03))) + ((Half.Abs(m10) + Half.Abs(m11)) + (Half.Abs(m12) + Half.Abs(m13)))) + (((Half.Abs(m20) + Half.Abs(m21)) + (Half.Abs(m22) + Half.Abs(m23))) + ((Half.Abs(m30) + Half.Abs(m31)) + (Half.Abs(m32) + Half.Abs(m33)))));
    
    /// <summary>
    /// Returns the two-norm of this matrix.
    /// </summary>
    public Half Norm2 => (Half)Math.Sqrt((double)((((m00*m00 + m01*m01) + (m02*m02 + m03*m03)) + ((m10*m10 + m11*m11) + (m12*m12 + m13*m13))) + (((m20*m20 + m21*m21) + (m22*m22 + m23*m23)) + ((m30*m30 + m31*m31) + (m32*m32 + m33*m33)))));
    ...
    {
        var m = Identity;
        m.m00 = ((byte)2 * nearVal) / (right - left);
        m.m11 = ((byte)2 * nearVal) / (top - bottom);
        m.m20 = (right + left) / (right - left);
        m.m21 = (top + bottom) / (top - bottom);
        m.m22 = -(farVal + nearVal) / (farVal - nearVal);
        m.m23 = -1;
        m.m32 = -((byte)2 * farVal * nearVal) / (farVal - nearVal);
        return m;
    }
    ...
    {
        var m = Identity;
        m.m00 = (byte)2/(right - left);
        m.m11 = (byte)2/(top - bottom);
        m.m22 = - 2/(zFar - zNear);
    ...
    public static hmat4 Perspective(Half fovy, Half aspect, Half zNear, Half zFar)
    {
        ...
        m.m23 = (Half)( -1 );
        m.m32 = (Half)( -((byte)2 * zFar * zNear) / (zFar - zNear) );
        return m;
    }
    ...
    {
        if (width <= (byte)0) throw new ArgumentOutOfRangeException("width");
        if (height <= (byte)0) throw new ArgumentOutOfRangeException("height");
        if (fov <= (byte)0) throw new ArgumentOutOfRangeException("fov");
        ...
        m.m23 = - 1;
        m.m32 = - ((byte)2*zFar*zNear)/(zFar - zNear);
        return m;
    }
    ...
    {
        var tmp = proj * (model * new hvec4(obj, (byte)1));
        tmp /= tmp.w;
        tmp = tmp * ((Half)(0.5)) + ((Half)(0.5));
    ...
    {
        var tmp = new hvec4(win, (byte)1);
        tmp.x = (tmp.x - viewport.x) / viewport.z;
        tmp.y = (tmp.y - viewport.y) / viewport.w;
        tmp = tmp * (byte)2 - (byte)1;
    ...
    public static hmat4 Rotate(Half angle, hvec3 v)
    {
        ...
        var temp = ((byte)1 - c) * axis;
    
        var m = Identity;
        m.m00 = c + temp.x * axis.x;
        m.m01 = (byte)0 + temp.x * axis.y + s * axis.z;
        m.m02 = (byte)0 + temp.x * axis.z - s * axis.y;
    
        m.m10 = (byte)0 + temp.y * axis.x - s * axis.z;
        m.m11 = c + temp.y * axis.y;
        m.m12 = (byte)0 + temp.y * axis.z + s * axis.x;
    
        m.m20 = (byte)0 + temp.z * axis.x + s * axis.y;
        m.m21 = (byte)0 + temp.z * axis.y - s * axis.x;
