...
public struct cmat3 : IReadOnlyList<Complex>, IEquatable<cmat3>
{
    ...
    /// </summary>
    public Complex Length => (Complex)Math.Sqrt(((((m00.LengthSqr() + m01.LengthSqr()) + m02.LengthSqr()) + (m10.LengthSqr() + m11.LengthSqr())) + ((m12.LengthSqr() + m20.LengthSqr()) + (m21.LengthSqr() + m22.LengthSqr()))));
    
    /// <summary>
    /// Returns the squared euclidean length of this matrix.
    /// </summary>
    public Complex LengthSqr => ((((m00.LengthSqr() + m01.LengthSqr()) + m02.LengthSqr()) + (m10.LengthSqr() + m11.LengthSqr())) + ((m12.LengthSqr() + m20.LengthSqr()) + (m21.LengthSqr() + m22.LengthSqr())));
    ...
    /// </summary>
    public Complex Norm => (Complex)Math.Sqrt(((((m00.LengthSqr() + m01.LengthSqr()) + m02.LengthSqr()) + (m10.LengthSqr() + m11.LengthSqr())) + ((m12.LengthSqr() + m20.LengthSqr()) + (m21.LengthSqr() + m22.LengthSqr()))));
    
    /// <summary>
    /// Returns the one-norm of this matrix.
    /// </summary>
    public Complex Norm1 => ((((m00.Magnitude + m01.Magnitude) + m02.Magnitude) + (m10.Magnitude + m11.Magnitude)) + ((m12.Magnitude + m20.Magnitude) + (m21.Magnitude + m22.Magnitude)));
    
    /// <summary>
    /// Returns the two-norm of this matrix.
    /// </summary>
    public Complex Norm2 => (Complex)Math.Sqrt(((((m00.LengthSqr() + m01.LengthSqr()) + m02.LengthSqr()) + (m10.LengthSqr() + m11.LengthSqr())) + ((m12.LengthSqr() + m20.LengthSqr()) + (m21.LengthSqr() + m22.LengthSqr()))));
