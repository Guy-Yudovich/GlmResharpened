...
public struct lvec2 : IReadOnlyList<long>, IEquatable<lvec2>
{
    ...
    /// </summary>
    public long LengthSqr => (long)(x*x + y*y);
    ...
    /// </summary>
    public long Norm => (long)Math.Sqrt((x*x + y*y));
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public long Norm1 => (Math.Abs(x) + Math.Abs(y));
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public long Norm2 => (long)Math.Sqrt((x*x + y*y));
    ...
    /// </summary>
    public static long Distance(lvec2 lhs, lvec2 rhs) => (lhs - rhs).Length;
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static long DistanceSqr(lvec2 lhs, lvec2 rhs) => (lhs - rhs).LengthSqr;
