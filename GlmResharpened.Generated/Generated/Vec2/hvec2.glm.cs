...
public static partial class glm
{
    ...
    /// </summary>
    public static Half Length(hvec2 v) => v.Length;
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public static Half LengthSqr(hvec2 v) => v.LengthSqr;
    ...
    /// </summary>
    public static Half Norm(hvec2 v) => v.Norm;
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public static Half Norm1(hvec2 v) => v.Norm1;
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public static Half Norm2(hvec2 v) => v.Norm2;
    
    /// <summary>
    /// Returns the max-norm of this vector.
    /// </summary>
    public static Half NormMax(hvec2 v) => v.NormMax;
    ...
    /// </summary>
    public static Half Distance(hvec2 lhs, hvec2 rhs) => hvec2.Distance(lhs, rhs);
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static Half DistanceSqr(hvec2 lhs, hvec2 rhs) => hvec2.DistanceSqr(lhs, rhs);
