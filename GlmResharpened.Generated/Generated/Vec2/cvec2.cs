...
public struct cvec2 : IReadOnlyList<Complex>, IEquatable<cvec2>
{
    ...
    /// </summary>
    public Complex Length => (Complex)Math.Sqrt((x.LengthSqr() + y.LengthSqr()));
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public Complex LengthSqr => (Complex)(x.LengthSqr() + y.LengthSqr());
    ...
    /// </summary>
    public Complex Norm => (Complex)Math.Sqrt((x.LengthSqr() + y.LengthSqr()));
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public Complex Norm1 => (x.Magnitude + y.Magnitude);
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public Complex Norm2 => (Complex)Math.Sqrt((x.LengthSqr() + y.LengthSqr()));
    ...
    /// </summary>
    public cvec2 NormalizedSafe => (this == Zero).AllTrue ? Zero : this / (Complex)Length;
    ...
    /// </summary>
    public static Complex Distance(cvec2 lhs, cvec2 rhs) => (lhs - rhs).Length;
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static Complex DistanceSqr(cvec2 lhs, cvec2 rhs) => (lhs - rhs).LengthSqr;
    ...
    /// </summary>
    public static bvec2 operator ==(cvec2 lhs, cvec2 rhs) => new bvec2(lhs.x == rhs.x, lhs.y == rhs.y);
    
    /// <summary>
    /// Returns a bvec2 from component-wise application of operator == (lhs == rhs).
    /// </summary>
    public static bvec2 operator ==(cvec2 lhs, Complex rhs) => new bvec2(lhs.x == rhs, lhs.y == rhs);
    
    /// <summary>
    /// Returns a bvec2 from component-wise application of operator == (lhs == rhs).
    /// </summary>
    public static bvec2 operator ==(Complex lhs, cvec2 rhs) => new bvec2(lhs == rhs.x, lhs == rhs.y);
