...
public static partial class glm
{
    ...
    /// </summary>
    public static long Length(lvec2 v) => v.Length;
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public static long LengthSqr(lvec2 v) => v.LengthSqr;
    ...
    /// </summary>
    public static long Norm(lvec2 v) => v.Norm;
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public static long Norm1(lvec2 v) => v.Norm1;
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public static long Norm2(lvec2 v) => v.Norm2;
    
    /// <summary>
    /// Returns the max-norm of this vector.
    /// </summary>
    public static long NormMax(lvec2 v) => v.NormMax;
    ...
    /// </summary>
    public static long Distance(lvec2 lhs, lvec2 rhs) => lvec2.Distance(lhs, rhs);
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static long DistanceSqr(lvec2 lhs, lvec2 rhs) => lvec2.DistanceSqr(lhs, rhs);
