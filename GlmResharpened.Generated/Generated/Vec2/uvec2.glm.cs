...
public static partial class glm
{
    ...
    /// </summary>
    public static uint Length(uvec2 v) => v.Length;
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public static uint LengthSqr(uvec2 v) => v.LengthSqr;
    ...
    /// </summary>
    public static uint Norm(uvec2 v) => v.Norm;
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public static uint Norm1(uvec2 v) => v.Norm1;
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public static uint Norm2(uvec2 v) => v.Norm2;
    
    /// <summary>
    /// Returns the max-norm of this vector.
    /// </summary>
    public static uint NormMax(uvec2 v) => v.NormMax;
    ...
    /// </summary>
    public static uint Distance(uvec2 lhs, uvec2 rhs) => uvec2.Distance(lhs, rhs);
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static uint DistanceSqr(uvec2 lhs, uvec2 rhs) => uvec2.DistanceSqr(lhs, rhs);
