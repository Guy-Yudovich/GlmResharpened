...
public struct decvec2 : IReadOnlyList<decimal>, IEquatable<decvec2>
{
    ...
    /// </summary>
    public decimal LengthSqr => (decimal)(x*x + y*y);
    ...
    /// </summary>
    public static bool ApproxEqual(decvec2 lhs, decvec2 rhs, decimal eps = 0.1m) => (decimal)Distance(lhs, rhs) <= eps;
    ...
    /// <summary>
    /// Returns a decvec2 from component-wise application of Floor ((decimal)Math.Floor((double)v)).
    /// </summary>
    public static decvec2 Floor(decvec2 v) => new decvec2((decimal)Math.Floor((double)v.x), (decimal)Math.Floor((double)v.y));
    
    /// <summary>
    /// Returns a decvec from the application of Floor ((decimal)Math.Floor((double)v)).
    /// </summary>
    public static decvec2 Floor(decimal v) => new decvec2((decimal)Math.Floor((double)v));
    
    /// <summary>
    /// Returns a decvec2 from component-wise application of Ceiling ((decimal)Math.Ceiling((double)v)).
    /// </summary>
    public static decvec2 Ceiling(decvec2 v) => new decvec2((decimal)Math.Ceiling((double)v.x), (decimal)Math.Ceiling((double)v.y));
    
    /// <summary>
    /// Returns a decvec from the application of Ceiling ((decimal)Math.Ceiling((double)v)).
    /// </summary>
    public static decvec2 Ceiling(decimal v) => new decvec2((decimal)Math.Ceiling((double)v));
    
    /// <summary>
    /// Returns a decvec2 from component-wise application of Round ((decimal)Math.Round((double)v)).
    /// </summary>
    public static decvec2 Round(decvec2 v) => new decvec2((decimal)Math.Round((double)v.x), (decimal)Math.Round((double)v.y));
    
    /// <summary>
    /// Returns a decvec from the application of Round ((decimal)Math.Round((double)v)).
    /// </summary>
    public static decvec2 Round(decimal v) => new decvec2((decimal)Math.Round((double)v));
    ...
    /// <summary>
    /// Returns a decvec2 from component-wise application of Fract ((v - (decimal)Math.Floor((double)v))).
    /// </summary>
    public static decvec2 Fract(decvec2 v) => new decvec2((v.x - (decimal)Math.Floor((double)v.x)), (v.y - (decimal)Math.Floor((double)v.y)));
    
    /// <summary>
    /// Returns a decvec from the application of Fract ((v - (decimal)Math.Floor((double)v))).
    /// </summary>
    public static decvec2 Fract(decimal v) => new decvec2((v - (decimal)Math.Floor((double)v)));
    
    /// <summary>
    /// Returns a decvec2 from component-wise application of Trunc ((decimal)(long)(v)).
    /// </summary>
    public static decvec2 Trunc(decvec2 v) => new decvec2((decimal)(long)(v.x), (decimal)(long)(v.y));
    
    /// <summary>
    /// Returns a decvec from the application of Trunc ((decimal)(long)(v)).
    /// </summary>
    public static decvec2 Trunc(decimal v) => new decvec2((decimal)(long)(v));
