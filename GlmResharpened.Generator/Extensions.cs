...
internal static class Extensions
{
	...
	public static string ParameterNameExtract(this string s) => s.Split('=')[0].Trim().Split(' ').Last().Trim();
	...
	public static string Indent(this string s, int lvl = 1) => new string(' ', lvl * 4) + s;

	public static IEnumerable<string> Indent(this IEnumerable<string> ss, int lvl = 1) => ss.Select(s => s.Indent(lvl));

	public static IEnumerable<string> TypedArgs(this IEnumerable<string> ss, AbstractType type) => ss.Select(s => type.Name + " " + s);

	public static IEnumerable<string> Format<T>(this IEnumerable<T> ss, string format) => ss.Select(s => string.Format(format, s));
	...
	public static IEnumerable<string> TypedArgs(this AbstractType type, params string[] args) => args.Select(a => type.NameThat + " " + a);
	public static IEnumerable<string> TypedArgs(this AbstractType type, IEnumerable<string> args) => args.Select(a => type.NameThat + " " + a);
	public static IEnumerable<string> SConcat(this IEnumerable<string> coll, params string[] args) => coll.Concat(args);
	...
	public static int GetPoisson(this double lambda, Random random) => lambda < 30.0 ? lambda.PoissonSmall(random) : lambda.PoissonLarge(random);
