...
internal class BuiltinType : AbstractType
{
	...
	public static List<KeyValuePair<BuiltinType, BuiltinType>> Upcasts
	{
		get
		{
			...
			{
				new(TypeInt, TypeLong),
				new(TypeInt, TypeFloat),
				new(TypeInt, TypeHalf),
				new(TypeInt, TypeDouble),
				new(TypeInt, TypeDecimal),

				new(TypeUint, TypeLong),
				new(TypeUint, TypeFloat),
				new(TypeUint, TypeHalf),
				new(TypeUint, TypeDouble),
				new(TypeUint, TypeDecimal),

				new(TypeHalf, TypeFloat),
				new(TypeHalf, TypeDouble),

				new(TypeFloat, TypeDouble),

				new(TypeLong, TypeDecimal),
				new(TypeInt, TypeComplex),
				new(TypeUint, TypeComplex),
				new(TypeHalf, TypeComplex),
				new(TypeFloat, TypeComplex),
				new(TypeDouble, TypeComplex)
			};
			return dic;
		}
	}

	public static readonly BuiltinType TypeInt = new()
	{
		TypeName = "int",
		Prefix = "i",
		IsInteger = true,
	...
	public static readonly BuiltinType TypeUint = new()
	{
		TypeName = "uint",
		Prefix = "u",
		OneValueConstant = "1u",
	...
	public static readonly BuiltinType TypeHalf = new()
	{
		TypeName = "Half",
		Prefix = "h",
	...
	public static readonly BuiltinType TypeFloat = new()
	{
		TypeName = "float",
		OneValueConstant = "1f",
	...
	public static readonly BuiltinType TypeDouble = new()
	{
		TypeName = "double",
		Prefix = "d",
		LengthType = "double",
	...
	public static readonly BuiltinType TypeDecimal = new()
	{
		TypeName = "decimal",
		Prefix = "dec",
		LengthType = "decimal",
	...
	public static readonly BuiltinType TypeComplex = new()
	{
		TypeName = "Complex",
		Prefix = "c",
		LengthType = "double",
	...
	public static readonly BuiltinType TypeLong = new()
	{
		TypeName = "long",
		Prefix = "l",
		LengthType = "double",
	...
	public static readonly BuiltinType TypeBool = new()
	{
		TypeName = "bool",
		Prefix = "b",
	...
	public static readonly BuiltinType TypeGeneric = new()
	{
		TypeName = "T",
		Prefix = "g",
		Generic = true,
	...
	public bool HasCastFromInt { get; set; } = true;
	...
	protected override IEnumerable<string> Body => throw new InvalidOperationException("No body for builtin types");

	public string[] TypeConstants { get; set; } = new string[] { };

	public Dictionary<string, string> TypeTestFuncs { get; set; } = [];
