...
public class ComplexSwizzleVec2Test
{
    ...
    {
        {
            var ov = new cvec2(new Complex(-2.5d, -7d), new Complex(8.5d, -0.5d));
            var v = ov.swizzle.xx;
            Assert.That(new Complex(-2.5d, -7d), Is.EqualTo(v.x));
            Assert.That(new Complex(-2.5d, -7d), Is.EqualTo(v.y));
        }
        {
            var ov = new cvec2(new Complex(6d, 9.5d), new Complex(-0.5d, 9d));
        ...
        {
            var ov = new cvec2(new Complex(1.0, 5.5d), new Complex(-4d, -9d));
        ...
        {
            var ov = new cvec2(new Complex(0.0, 3d), new Complex(0.0, 0.0));
        ...
        {
            var ov = new cvec2(new Complex(-0.5d, -1.5d), new Complex(-6.5d, -7.5d));
        ...
        {
            var ov = new cvec2(new Complex(4.5d, 5d), new Complex(9.5d, 2.5d));
        ...
        {
            var ov = new cvec2(new Complex(7d, -1.5d), new Complex(7.5d, 4.5d));
        ...
        {
            var ov = new cvec2(new Complex(-8d, 2d), new Complex(-0.5d, 9.5d));
            var v = ov.swizzle.xy;
            Assert.That(new Complex(-8d, 2d), Is.EqualTo(v.x));
            Assert.That(new Complex(-0.5d, 9.5d), Is.EqualTo(v.y));
        }
        {
            var ov = new cvec2(new Complex(2d, 8d), new Complex(-1.5d, 1.0));
        ...
        {
            var ov = new cvec2(new Complex(5.5d, 6d), new Complex(-6d, 6.5d));
        ...
        {
            var ov = new cvec2(new Complex(7.5d, 0.0), new Complex(4.5d, -5.5d));
        ...
        {
            var ov = new cvec2(new Complex(5.5d, 7.5d), new Complex(7d, 7.5d));
        ...
        {
            var ov = new cvec2(new Complex(0.0, 2d), new Complex(-7d, 5d));
        ...
        {
            var ov = new cvec2(new Complex(1.5d, -6d), new Complex(-2.5d, -3d));
        ...
        {
            var ov = new cvec2(new Complex(-5.5d, 5d), new Complex(-9.5d, 6d));
            var v = ov.swizzle.yx;
            Assert.That(new Complex(-9.5d, 6d), Is.EqualTo(v.x));
            Assert.That(new Complex(-5.5d, 5d), Is.EqualTo(v.y));
        }
        {
            var ov = new cvec2(new Complex(2d, 5d), new Complex(-9.5d, 7d));
        ...
        {
            var ov = new cvec2(new Complex(-6.5d, 3.5d), new Complex(4.5d, -8d));
        ...
        {
            var ov = new cvec2(new Complex(4d, 4d), new Complex(-7d, -5d));
        ...
        {
            var ov = new cvec2(new Complex(6.5d, -7.5d), new Complex(9d, -1d));
        ...
        {
            var ov = new cvec2(new Complex(-5.5d, 4d), new Complex(9d, 3.5d));
        ...
        {
            var ov = new cvec2(new Complex(-2d, -9.5d), new Complex(-6.5d, 0.0));
        ...
        {
            var ov = new cvec2(new Complex(-9d, 0.5d), new Complex(2.5d, 5.5d));
            var v = ov.swizzle.yy;
            Assert.That(new Complex(2.5d, 5.5d), Is.EqualTo(v.x));
            Assert.That(new Complex(2.5d, 5.5d), Is.EqualTo(v.y));
        }
        {
            var ov = new cvec2(new Complex(-8d, 0.5d), new Complex(2d, 9d));
        ...
        {
            var ov = new cvec2(new Complex(-2d, -8d), new Complex(6d, -4d));
        ...
        {
            var ov = new cvec2(new Complex(5.5d, -4d), new Complex(-4d, -8.5d));
        ...
        {
            var ov = new cvec2(new Complex(-9.5d, 4.5d), new Complex(-1.5d, -3.5d));
        ...
        {
            var ov = new cvec2(new Complex(-9.5d, -8.5d), new Complex(1.5d, -4d));
        ...
        {
            var ov = new cvec2(new Complex(-1.5d, 0.0), new Complex(2.5d, 2.5d));
    ...
    {
        {
            var ov = new cvec2(new Complex(-1d, -3d), new Complex(7.5d, -8.5d));
            var v = ov.swizzle.rr;
            Assert.That(new Complex(-1d, -3d), Is.EqualTo(v.x));
            Assert.That(new Complex(-1d, -3d), Is.EqualTo(v.y));
        }
        {
            var ov = new cvec2(new Complex(3d, -5d), new Complex(9.5d, 0.0));
        ...
        {
            var ov = new cvec2(new Complex(-2d, 3.5d), new Complex(8.5d, 5.5d));
        ...
        {
            var ov = new cvec2(new Complex(0.0, 9.5d), new Complex(3.5d, 9d));
        ...
        {
            var ov = new cvec2(new Complex(1.0, 9.5d), new Complex(-6.5d, 7.5d));
        ...
        {
            var ov = new cvec2(new Complex(4d, -3d), new Complex(9d, -7d));
        ...
        {
            var ov = new cvec2(new Complex(9.5d, 3.5d), new Complex(9d, -5d));
        ...
        {
            var ov = new cvec2(new Complex(4d, 7d), new Complex(-8.5d, 2.5d));
            var v = ov.swizzle.rg;
            Assert.That(new Complex(4d, 7d), Is.EqualTo(v.x));
            Assert.That(new Complex(-8.5d, 2.5d), Is.EqualTo(v.y));
        }
        {
            var ov = new cvec2(new Complex(-0.5d, -6.5d), new Complex(3d, 3.5d));
        ...
        {
            var ov = new cvec2(new Complex(-2d, 1.5d), new Complex(-2.5d, 8d));
        ...
        {
            var ov = new cvec2(new Complex(6d, 5.5d), new Complex(-8d, -4d));
        ...
        {
            var ov = new cvec2(new Complex(7d, -0.5d), new Complex(1.5d, -8d));
        ...
        {
            var ov = new cvec2(new Complex(8d, -1.5d), new Complex(-0.5d, 6.5d));
        ...
        {
            var ov = new cvec2(new Complex(2.5d, 3d), new Complex(-6.5d, 6.5d));
        ...
        {
            var ov = new cvec2(new Complex(6d, -1d), new Complex(4.5d, 1.0));
            var v = ov.swizzle.gr;
            Assert.That(new Complex(4.5d, 1.0), Is.EqualTo(v.x));
            Assert.That(new Complex(6d, -1d), Is.EqualTo(v.y));
        }
        {
            var ov = new cvec2(new Complex(3d, -2d), new Complex(0.5d, -6d));
        ...
        {
            var ov = new cvec2(new Complex(-6.5d, -2d), new Complex(-3.5d, 1.5d));
        ...
        {
            var ov = new cvec2(new Complex(-3d, -4.5d), new Complex(-8.5d, 7d));
        ...
        {
            var ov = new cvec2(new Complex(0.0, 7d), new Complex(-8.5d, 6.5d));
        ...
        {
            var ov = new cvec2(new Complex(-3d, 2.5d), new Complex(5d, -3.5d));
        ...
        {
            var ov = new cvec2(new Complex(-3.5d, 5.5d), new Complex(-2d, -9.5d));
        ...
        {
            var ov = new cvec2(new Complex(-4d, 5.5d), new Complex(-1d, -6d));
            var v = ov.swizzle.gg;
            Assert.That(new Complex(-1d, -6d), Is.EqualTo(v.x));
            Assert.That(new Complex(-1d, -6d), Is.EqualTo(v.y));
        }
        {
            var ov = new cvec2(new Complex(-6d, -5.5d), new Complex(4.5d, -1.5d));
        ...
        {
            var ov = new cvec2(new Complex(-3.5d, 8.5d), new Complex(3.5d, -7d));
        ...
        {
            var ov = new cvec2(new Complex(3.5d, 3.5d), new Complex(-6.5d, -1.5d));
        ...
        {
            var ov = new cvec2(new Complex(-6.5d, -3d), new Complex(-9.5d, -1.5d));
        ...
        {
            var ov = new cvec2(new Complex(-9.5d, -7.5d), new Complex(-6d, 3d));
        ...
        {
            var ov = new cvec2(new Complex(9.5d, -7.5d), new Complex(2.5d, 8.5d));
    ...
    {
        {
            var v0 = new cvec2(new Complex(4d, -6.5d), new Complex(-7d, 7d));
            var v1 = new cvec2(new Complex(7.5d, 3d), new Complex(6d, -6.5d));
            var v2 = v0.xy;
            v0.xy = v1;
            var v3 = v0.xy;
            ...
            Assert.That(new Complex(4d, -6.5d), Is.EqualTo(v2.x));
            Assert.That(new Complex(-7d, 7d), Is.EqualTo(v2.y));
        }
    }
    ...
    {
        {
            var v0 = new cvec2(new Complex(8d, 9d), new Complex(-2.5d, 4.5d));
            var v1 = new Complex(7d, -1.5d);
            var v2 = v0.r;
            v0.r = v1;
            var v3 = v0.r;
            ...
            Assert.That(new Complex(7d, -1.5d), Is.EqualTo(v0.x));
            Assert.That(new Complex(-2.5d, 4.5d), Is.EqualTo(v0.y));
        
            Assert.That(new Complex(8d, 9d), Is.EqualTo(v2));
        }
        {
            var v0 = new cvec2(new Complex(-4.5d, -5d), new Complex(2.5d, 4d));
            ...
            Assert.That(new Complex(-4.5d, -5d), Is.EqualTo(v0.x));
            Assert.That(new Complex(5d, -6.5d), Is.EqualTo(v0.y));
        
            Assert.That(new Complex(2.5d, 4d), Is.EqualTo(v2));
        }
        {
            var v0 = new cvec2(new Complex(6.5d, -1d), new Complex(0.5d, -3.5d));
            var v1 = new cvec2(new Complex(9.5d, 5.5d), new Complex(7.5d, 8.5d));
            var v2 = v0.rg;
            v0.rg = v1;
            var v3 = v0.rg;
            ...
            Assert.That(new Complex(7.5d, 8.5d), Is.EqualTo(v0.y));
        
            Assert.That(new Complex(6.5d, -1d), Is.EqualTo(v2.x));
            Assert.That(new Complex(0.5d, -3.5d), Is.EqualTo(v2.y));
        }
    }
