...
public class FloatSwizzleVec2Test
{
    ...
    public void XYZW()
    {
        ...
        {
            var ov = new vec2(-4f, 5.5f);
            var v = ov.swizzle.yy;
            Assert.That(5.5f, Is.EqualTo(v.x));
            Assert.That(5.5f, Is.EqualTo(v.y));
        }
        {
            var ov = new vec2(-1.5f, 7f);
    ...
    {
        {
            ...
            Assert.That(5f, Is.EqualTo(v2));
        }
        {
            var v0 = new vec2(2f, -7.5f);
            var v1 = -7.5f;
            var v2 = v0.g;
            v0.g = v1;
            var v3 = v0.g;
