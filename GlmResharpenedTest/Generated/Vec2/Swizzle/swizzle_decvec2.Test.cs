...
public class DecimalSwizzleVec2Test
{
    ...
    public void XYZW()
    {
        ...
        {
            var ov = new decvec2(-1m, 2m);
            var v = ov.swizzle.yx;
            Assert.That(2m, Is.EqualTo(v.x));
            Assert.That(-1m, Is.EqualTo(v.y));
        }
        {
            var ov = new decvec2(-8m, 6.5m);
    ...
    public void RGBA()
    {
        ...
        {
            var ov = new decvec2(9.5m, -8m);
            var v = ov.swizzle.rg;
            Assert.That(9.5m, Is.EqualTo(v.x));
            Assert.That(-8m, Is.EqualTo(v.y));
        }
        {
            var ov = new decvec2(3.5m, 0m);
        ...
        {
            var ov = new decvec2(-3.5m, 1.5m);
            var v = ov.swizzle.gg;
            Assert.That(1.5m, Is.EqualTo(v.x));
            Assert.That(1.5m, Is.EqualTo(v.y));
        }
        {
            var ov = new decvec2(7.5m, -7.5m);
