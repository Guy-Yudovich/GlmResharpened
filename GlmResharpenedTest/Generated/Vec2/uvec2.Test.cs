...
public class UintVec2Test
{
    ...
    public void InvariantAssociative()
    {
        ...
        }
        {
            ...
            var v2 = new uvec2(5u, 6u);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new uvec2(5u, 3u);
            var v1 = new uvec2(6u, 8u);
            var v2 = new uvec2(1u, 8u);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new uvec2(8u, 1u);
            var v1 = new uvec2(8u, 3u);
            var v2 = new uvec2(6u, 5u);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new uvec2(8u, 3u);
            var v1 = new uvec2(1u, 0u);
            var v2 = new uvec2(1u, 7u);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new uvec2(1u, 4u);
            var v1 = new uvec2(5u, 7u);
            var v2 = new uvec2(9u, 7u);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new uvec2(1u, 3u);
        ...
        }
        {
            ...
            var v2 = new uvec2(2u, 3u);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new uvec2(0u, 0u);
            var v1 = new uvec2(1u, 9u);
            var v2 = new uvec2(8u, 5u);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new uvec2(8u, 9u);
            var v1 = new uvec2(7u, 8u);
            var v2 = new uvec2(6u, 1u);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
    }
    ...
    {
        var random = new Random(811194423);
    ...
    {
        var random = new Random(1333995149);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = uvec2.RandomUniform(random, (2), (4));
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
    ...
    {
        var random = new Random(1070651047);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(1763442246);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = uvec2.RandomUniform(random, (1), (3));
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
    ...
    {
        var random = new Random(1652614603);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(532428409);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = uvec2.RandomPoisson(random, 2.4272187379781243);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(2.4272187379781243).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(2.4272187379781243).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(2.4272187379781243).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(2.4272187379781243).Within(3.0));
    }

    [Test]
    public void RandomPoisson1()
    {
        var random = new Random(2142254084);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = uvec2.RandomPoisson(random, 1.9954147406366722);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(1.9954147406366722).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(1.9954147406366722).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(1.9954147406366722).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(1.9954147406366722).Within(3.0));
    }

    [Test]
    public void RandomPoisson2()
    {
        var random = new Random(1329361602);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = uvec2.RandomPoisson(random, 2.7524566083459447);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(2.7524566083459447).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(2.7524566083459447).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(2.7524566083459447).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(2.7524566083459447).Within(3.0));
    }

    [Test]
    public void RandomPoisson3()
    {
        var random = new Random(1648568553);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = uvec2.RandomPoisson(random, 2.014584660304051);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(2.014584660304051).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(2.014584660304051).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(2.014584660304051).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(2.014584660304051).Within(3.0));
    }

    [Test]
    public void RandomPoisson4()
    {
        var random = new Random(748139403);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = uvec2.RandomPoisson(random, 0.5889760479745344);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(0.5889760479745344).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(0.5889760479745344).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(0.5889760479745344).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(0.5889760479745344).Within(3.0));
    }
