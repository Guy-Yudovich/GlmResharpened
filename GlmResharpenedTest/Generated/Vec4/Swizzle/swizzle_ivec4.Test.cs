...
public class IntSwizzleVec4Test
{
    ...
    public void XYZW()
    {
        ...
        {
            var ov = new ivec4(9, 8, 3, -5);
            var v = ov.swizzle.yw;
            Assert.That(8, Is.EqualTo(v.x));
            Assert.That(-5, Is.EqualTo(v.y));
        }
        {
            var ov = new ivec4(-2, 8, -5, 3);
        ...
        {
            var ov = new ivec4(0, 2, -2, -6);
            var v = ov.swizzle.zy;
            Assert.That(-2, Is.EqualTo(v.x));
            Assert.That(2, Is.EqualTo(v.y));
        }
        {
            var ov = new ivec4(8, -3, -5, 8);
        ...
        {
            var ov = new ivec4(5, -8, -1, 9);
            var v = ov.swizzle.zw;
            Assert.That(-1, Is.EqualTo(v.x));
            Assert.That(9, Is.EqualTo(v.y));
        }
        {
            var ov = new ivec4(-6, 9, -2, 0);
        ...
        {
            var ov = new ivec4(-5, 1, 6, -8);
            var v = ov.swizzle.wy;
            Assert.That(-8, Is.EqualTo(v.x));
            Assert.That(1, Is.EqualTo(v.y));
        }
        {
            var ov = new ivec4(9, 3, 1, -3);
        ...
        {
            var ov = new ivec4(-6, -1, -3, 7);
            var v = ov.swizzle.wz;
            Assert.That(7, Is.EqualTo(v.x));
            Assert.That(-3, Is.EqualTo(v.y));
        }
        {
            var ov = new ivec4(6, 6, 8, 1);
    ...
    {
        {
            var ov = new ivec4(4, 4, -1, 9);
            var v = ov.swizzle.rr;
            Assert.That(4, Is.EqualTo(v.x));
            Assert.That(4, Is.EqualTo(v.y));
        }
        {
            var ov = new ivec4(-3, -2, 6, -9);
        ...
        {
            var ov = new ivec4(-5, 2, -6, -5);
            var v = ov.swizzle.ga;
            Assert.That(2, Is.EqualTo(v.x));
            Assert.That(-5, Is.EqualTo(v.y));
        }
        {
            var ov = new ivec4(8, -7, -4, -7);
        ...
        {
            var ov = new ivec4(-3, 8, -4, 5);
            var v = ov.swizzle.bg;
            Assert.That(-4, Is.EqualTo(v.x));
            Assert.That(8, Is.EqualTo(v.y));
        }
        {
            var ov = new ivec4(-8, -3, -6, 9);
        ...
        {
            var ov = new ivec4(3, 8, 1, -6);
            var v = ov.swizzle.ba;
            Assert.That(1, Is.EqualTo(v.x));
            Assert.That(-6, Is.EqualTo(v.y));
        }
        {
            var ov = new ivec4(-1, -3, 1, 1);
    ...
    public void InlineXYZW()
    {
        ...
        {
            var v0 = new ivec4(1, -8, 9, 2);
            var v1 = new ivec3(6, 5, 7);
            var v2 = v0.xyz;
            v0.xyz = v1;
            var v3 = v0.xyz;
        ...
        {
            var v0 = new ivec4(4, 6, -8, 6);
            var v1 = new ivec3(-2, -9, -5);
            var v2 = v0.xzw;
            v0.xzw = v1;
            var v3 = v0.xzw;
        ...
        {
            var v0 = new ivec4(2, 4, 9, 6);
            var v1 = new ivec3(9, -1, -4);
            var v2 = v0.yzw;
            v0.yzw = v1;
            var v3 = v0.yzw;
        ...
        {
            var v0 = new ivec4(4, 6, -4, -9);
            var v1 = new ivec4(-1, 7, 9, 6);
            var v2 = v0.xyzw;
            v0.xyzw = v1;
            var v3 = v0.xyzw;
    ...
    public void InlineRGBA()
    {
        ...
        {
            var v0 = new ivec4(1, -2, 8, -1);
            var v1 = new ivec3(-4, -4, 8);
            var v2 = v0.rgb;
            v0.rgb = v1;
            var v3 = v0.rgb;
        ...
        {
            var v0 = new ivec4(-6, -9, 1, -4);
            var v1 = new ivec3(-9, 1, -6);
            var v2 = v0.rba;
            v0.rba = v1;
            var v3 = v0.rba;
        ...
        {
            var v0 = new ivec4(1, 1, 8, -3);
            var v1 = new ivec3(-6, 6, 1);
            var v2 = v0.gba;
            v0.gba = v1;
            var v3 = v0.gba;
        ...
        {
            var v0 = new ivec4(7, -5, 0, -6);
            var v1 = new ivec4(-9, 6, -6, 4);
            var v2 = v0.rgba;
            v0.rgba = v1;
            var v3 = v0.rgba;
