...
public class IntSwizzleVec4Test
{
    ...
    public void XYZW()
    {
        ...
        {
            var ov = new ivec4(-1, 7, 9, -1);
            var v = ov.swizzle.xy;
            Assert.That(-1, Is.EqualTo(v.x));
            Assert.That(7, Is.EqualTo(v.y));
        }
        {
            var ov = new ivec4(0, 2, 5, 0);
        ...
        {
            var ov = new ivec4(-4, 7, -1, 8);
            var v = ov.swizzle.xw;
            Assert.That(-4, Is.EqualTo(v.x));
            Assert.That(8, Is.EqualTo(v.y));
        }
        {
            var ov = new ivec4(2, -5, -1, 9);
        ...
        {
            var ov = new ivec4(-1, 0, 9, -3);
            var v = ov.swizzle.yy;
            Assert.That(0, Is.EqualTo(v.x));
            Assert.That(0, Is.EqualTo(v.y));
        }
        {
            var ov = new ivec4(-7, 3, -3, -5);
    ...
    public void RGBA()
    {
        ...
        {
            var ov = new ivec4(3, 0, 4, -8);
            var v = ov.swizzle.gr;
            Assert.That(0, Is.EqualTo(v.x));
            Assert.That(3, Is.EqualTo(v.y));
        }
        {
            var ov = new ivec4(9, 5, -4, -2);
        ...
        {
            var ov = new ivec4(-8, -1, -8, 8);
            var v = ov.swizzle.bg;
            Assert.That(-8, Is.EqualTo(v.x));
            Assert.That(-1, Is.EqualTo(v.y));
        }
        {
            var ov = new ivec4(-6, -6, -1, -4);
        ...
        {
            var ov = new ivec4(-7, -1, 8, -5);
            var v = ov.swizzle.ba;
            Assert.That(8, Is.EqualTo(v.x));
            Assert.That(-5, Is.EqualTo(v.y));
        }
        {
            var ov = new ivec4(-3, -1, 0, -8);
        ...
        {
            var ov = new ivec4(-6, 0, 8, 6);
            var v = ov.swizzle.ar;
            Assert.That(6, Is.EqualTo(v.x));
            Assert.That(-6, Is.EqualTo(v.y));
        }
        {
            var ov = new ivec4(-7, 3, 3, -2);
        ...
        {
            var ov = new ivec4(-2, -7, 2, -4);
            var v = ov.swizzle.ab;
            Assert.That(-4, Is.EqualTo(v.x));
            Assert.That(2, Is.EqualTo(v.y));
        }
        {
            var ov = new ivec4(0, 0, 2, 4);
    ...
    public void InlineXYZW()
    {
        ...
        {
            var v0 = new ivec4(-9, 8, 3, 6);
            var v1 = new ivec3(-1, 4, 1);
            var v2 = v0.xyw;
            v0.xyw = v1;
            var v3 = v0.xyw;
        ...
        {
            var v0 = new ivec4(-1, -4, 6, 9);
            var v1 = new ivec3(6, 7, -4);
            var v2 = v0.xzw;
            v0.xzw = v1;
            var v3 = v0.xzw;
        ...
        {
            var v0 = new ivec4(-8, -1, 0, -7);
            var v1 = new ivec3(8, -8, -4);
            var v2 = v0.yzw;
            v0.yzw = v1;
            var v3 = v0.yzw;
        ...
        {
            var v0 = new ivec4(5, -3, -2, 8);
            var v1 = new ivec4(4, -7, -9, -3);
            var v2 = v0.xyzw;
            v0.xyzw = v1;
            var v3 = v0.xyzw;
    ...
    public void InlineRGBA()
    {
        ...
        {
            var v0 = new ivec4(0, 7, 2, -5);
            var v1 = new ivec3(5, 3, 7);
            var v2 = v0.rgb;
            v0.rgb = v1;
            var v3 = v0.rgb;
        ...
        {
            var v0 = new ivec4(8, 3, -5, 9);
            var v1 = new ivec3(1, -5, 7);
            var v2 = v0.rga;
            v0.rga = v1;
            var v3 = v0.rga;
        ...
        {
            var v0 = new ivec4(9, 8, 8, -1);
            var v1 = new ivec3(-5, -6, 9);
            var v2 = v0.gba;
            v0.gba = v1;
            var v3 = v0.gba;
        ...
        {
            var v0 = new ivec4(8, -8, 3, 0);
            var v1 = new ivec4(-4, -5, 9, 5);
            var v2 = v0.rgba;
            v0.rgba = v1;
            var v3 = v0.rgba;
