...
public class FloatSwizzleVec2Test
{
    ...
    public void XYZW()
    {
        ...
        {
            var ov = new vec2(5f, -1.5f);
            var v = ov.swizzle.yy;
            Assert.That(-1.5f, Is.EqualTo(v.x));
            Assert.That(-1.5f, Is.EqualTo(v.y));
        }
        {
            var ov = new vec2(-5.5f, -4f);
    ...
    public void InlineRGBA()
    {
        ...
        {
            vec2 v0 = new vec2(-8f, -6f);
            vec2 v1 = new vec2(0.5f, -3.5f);
            var v2 = v0.rg;
            v0.rg = v1;
            var v3 = v0.rg;
