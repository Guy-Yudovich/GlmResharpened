...
public class DoubleSwizzleVec2Test
{
    ...
    public void XYZW()
    {
        ...
        {
            var ov = new dvec2(5d, -7d);
            var v = ov.swizzle.yx;
            Assert.That(-7d, Is.EqualTo(v.x));
            Assert.That(5d, Is.EqualTo(v.y));
        }
        {
            var ov = new dvec2(-3.5d, -2d);
    ...
    public void InlineRGBA()
    {
        ...
        {
            dvec2 v0 = new dvec2(1.0, -8d);
            dvec2 v1 = new dvec2(0.0, 7d);
            var v2 = v0.rg;
            v0.rg = v1;
            var v3 = v0.rg;
