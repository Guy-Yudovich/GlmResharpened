...
public class UintVec2Test
{
    ...
    public void PropertyValues()
    {
        ...
        Assert.That(2u, Is.EqualTo(vals[1]));
    ...
    public void Operators()
    {
        ...
        var v2 = new uvec2(5u, 2u);
        var v3 = new uvec2(2u, 5u);
    ...
    public void InvariantAssociative()
    {
        ...
        }
        {
            ...
            var v1 = new uvec2(8u, 6u);
            var v2 = new uvec2(2u, 7u);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new uvec2(2u, 8u);
            var v1 = new uvec2(2u, 0u);
    ...
    {
        var random = new Random(1797944491);
    ...
    {
        var random = new Random(239556913);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(788016207);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(2054256401);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(1420108525);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(859586643);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = uvec2.RandomPoisson(random, 1.279354953569991);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(1.279354953569991).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(1.279354953569991).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(1.279354953569991).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(1.279354953569991).Within(3.0));
    }

    [Test]
    public void RandomPoisson1()
    {
        var random = new Random(910193208);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = uvec2.RandomPoisson(random, 2.5193158602431955);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(2.5193158602431955).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(2.5193158602431955).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(2.5193158602431955).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(2.5193158602431955).Within(3.0));
    }

    [Test]
    public void RandomPoisson2()
    {
        var random = new Random(1465738352);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = uvec2.RandomPoisson(random, 0.944416434245378);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(0.944416434245378).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(0.944416434245378).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(0.944416434245378).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(0.944416434245378).Within(3.0));
    }

    [Test]
    public void RandomPoisson3()
    {
        var random = new Random(1841002136);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = uvec2.RandomPoisson(random, 0.9007362832318695);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(0.9007362832318695).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(0.9007362832318695).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(0.9007362832318695).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(0.9007362832318695).Within(3.0));
    }

    [Test]
    public void RandomPoisson4()
    {
        var random = new Random(2104392646);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = uvec2.RandomPoisson(random, 0.7175096204585907);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(0.7175096204585907).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(0.7175096204585907).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(0.7175096204585907).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(0.7175096204585907).Within(3.0));
    }
