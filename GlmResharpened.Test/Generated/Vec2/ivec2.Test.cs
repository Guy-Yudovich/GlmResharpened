...
public class IntVec2Test
{
    ...
    public void Constructors()
    {
        ...
        {
            var v = new ivec2(new ivec2(8, 4));
            Assert.That(8, Is.EqualTo(v.x));
            Assert.That(4, Is.EqualTo(v.y));
        }
        {
            var v = new ivec2(new ivec3(-9, 4, 5));
            Assert.That(-9, Is.EqualTo(v.x));
            Assert.That(4, Is.EqualTo(v.y));
        }
        {
            var v = new ivec2(new ivec4(9, -6, -5, -2));
            Assert.That(9, Is.EqualTo(v.x));
            Assert.That(-6, Is.EqualTo(v.y));
        }
    }
    ...
    public void PropertyValues()
    {
        ...
        Assert.That(-5, Is.EqualTo(vals[1]));
    ...
    {
        {
            ...
            var v2 = new ivec2(-4, -8);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
            var v0 = new ivec2(9, -9);
            var v1 = new ivec2(1, 4);
            var v2 = new ivec2(-7, 1);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
            var v0 = new ivec2(4, 6);
        ...
        }
        {
            ...
            var v1 = new ivec2(-2, -9);
            var v2 = new ivec2(9, -2);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
            var v0 = new ivec2(-2, 8);
            var v1 = new ivec2(7, 7);
            var v2 = new ivec2(-3, 3);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
            var v0 = new ivec2(6, -5);
            var v1 = new ivec2(0, -9);
            var v2 = new ivec2(6, -6);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
            var v0 = new ivec2(-1, 4);
        ...
        }
        {
            ...
            var v2 = new ivec2(7, -7);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
            var v0 = new ivec2(-5, 5);
            var v1 = new ivec2(9, -8);
            var v2 = new ivec2(1, 4);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
    }
    ...
    {
        var random = new Random(1217785897);
    ...
    {
        var random = new Random(1615184986);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(2141373098);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(322389614);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = ivec2.RandomUniform(random, (-1), (3));
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
    ...
    {
        var random = new Random(1159598979);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(821399175);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = ivec2.RandomPoisson(random, 2.0326870649739575);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(2.0326870649739575).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(2.0326870649739575).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(2.0326870649739575).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(2.0326870649739575).Within(3.0));
    }

    [Test]
    public void RandomPoisson1()
    {
        var random = new Random(1383773722);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = ivec2.RandomPoisson(random, 1.1861934567271701);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(1.1861934567271701).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(1.1861934567271701).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(1.1861934567271701).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(1.1861934567271701).Within(3.0));
    }

    [Test]
    public void RandomPoisson2()
    {
        var random = new Random(1658476347);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = ivec2.RandomPoisson(random, 3.4405857817924517);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(3.4405857817924517).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(3.4405857817924517).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(3.4405857817924517).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(3.4405857817924517).Within(3.0));
    }

    [Test]
    public void RandomPoisson3()
    {
        var random = new Random(96794517);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = ivec2.RandomPoisson(random, 1.395156864959354);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(1.395156864959354).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(1.395156864959354).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(1.395156864959354).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(1.395156864959354).Within(3.0));
    }

    [Test]
    public void RandomPoisson4()
    {
        var random = new Random(867398409);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = ivec2.RandomPoisson(random, 2.058021113070669);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(2.058021113070669).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(2.058021113070669).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(2.058021113070669).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(2.058021113070669).Within(3.0));
    }
