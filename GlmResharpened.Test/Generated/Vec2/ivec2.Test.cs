...
public class IntVec2Test
{
    ...
    public void Constructors()
    {
        ...
        {
            var v = new ivec2(new ivec2(1, -5));
            Assert.That(1, Is.EqualTo(v.x));
            Assert.That(-5, Is.EqualTo(v.y));
        }
        {
            var v = new ivec2(new ivec3(1, 0, -5));
            Assert.That(1, Is.EqualTo(v.x));
            Assert.That(0, Is.EqualTo(v.y));
        }
        {
            var v = new ivec2(new ivec4(4, -3, -5, 6));
    ...
    public void PropertyValues()
    {
        var v = new ivec2(5, 0);
        var vals = v.Values;
        Assert.That(5, Is.EqualTo(vals[0]));
    ...
    public void InvariantAssociative()
    {
        ...
        }
        {
            ...
            var v2 = new ivec2(7, -3);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new ivec2(-9, 3);
            var v1 = new ivec2(-8, -6);
            var v2 = new ivec2(-9, -7);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new ivec2(-4, 3);
            var v1 = new ivec2(-2, -2);
            var v2 = new ivec2(0, -2);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
    ...
    public void InvariantAssociativeNeg()
    {
        ...
        {
            var v0 = new ivec2(9, -9);
            var v1 = new ivec2(0, 0);
            var v2 = new ivec2(-9, -4);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
        ...
        }
        {
            ...
            var v1 = new ivec2(9, 6);
            var v2 = new ivec2(2, -9);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
            var v0 = new ivec2(-1, -2);
    ...
    {
        var random = new Random(1101990332);
    ...
    {
        var random = new Random(1047722792);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = ivec2.RandomUniform(random, (-3), (-1));
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
    ...
    {
        var random = new Random(2111918616);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(222345014);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(1479826298);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(544014383);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = ivec2.RandomPoisson(random, 1.477304974094641);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(1.477304974094641).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(1.477304974094641).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(1.477304974094641).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(1.477304974094641).Within(3.0));
    }

    [Test]
    public void RandomPoisson1()
    {
        var random = new Random(1225765468);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = ivec2.RandomPoisson(random, 0.6115119248216562);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(0.6115119248216562).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(0.6115119248216562).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(0.6115119248216562).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(0.6115119248216562).Within(3.0));
    }

    [Test]
    public void RandomPoisson2()
    {
        var random = new Random(1969025000);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = ivec2.RandomPoisson(random, 2.8522203696669175);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(2.8522203696669175).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(2.8522203696669175).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(2.8522203696669175).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(2.8522203696669175).Within(3.0));
    }

    [Test]
    public void RandomPoisson3()
    {
        var random = new Random(9090749);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = ivec2.RandomPoisson(random, 0.9110198097354825);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(0.9110198097354825).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(0.9110198097354825).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(0.9110198097354825).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(0.9110198097354825).Within(3.0));
    }

    [Test]
    public void RandomPoisson4()
    {
        var random = new Random(795542177);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = ivec2.RandomPoisson(random, 2.62531355588013);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(2.62531355588013).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(2.62531355588013).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(2.62531355588013).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(2.62531355588013).Within(3.0));
    }
