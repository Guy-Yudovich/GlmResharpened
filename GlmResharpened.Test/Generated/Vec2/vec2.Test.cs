...
public class FloatVec2Test
{
    ...
    public void Operators()
    {
        ...
        var v2 = new vec2(4.5f, -9.5f);
        var v3 = new vec2(-9.5f, 4.5f);
    ...
    {
        {
            var v0 = new vec2(-5f, 9.5f);
            Assert.That(v0, Is.EqualTo(+v0));
        }
        {
            var v0 = new vec2(5.5f, -6.5f);
            Assert.That(v0, Is.EqualTo(+v0));
        }
        {
        ...
        {
            var v0 = new vec2(9.5f, -1.5f);
            Assert.That(v0, Is.EqualTo(+v0));
        }
        {
            var v0 = new vec2(-9.5f, 2f);
            Assert.That(v0, Is.EqualTo(+v0));
        }
        {
    ...
    public void InvariantDouble()
    {
        ...
        {
            var v0 = new vec2(-5.5f, -9f);
            Assert.That(v0 + v0, Is.EqualTo(2 * v0));
        }
        {
            var v0 = new vec2(1.5f, 8.5f);
            Assert.That(v0 + v0, Is.EqualTo(2 * v0));
        }
        {
            var v0 = new vec2(-1.5f, 7f);
            Assert.That(v0 + v0, Is.EqualTo(2 * v0));
        }
        {
    ...
    public void InvariantTriple()
    {
        ...
        {
            var v0 = new vec2(1.5f, 0f);
            Assert.That(v0 + v0 + v0, Is.EqualTo(3 * v0));
        }
        {
            var v0 = new vec2(-5f, -5f);
            Assert.That(v0 + v0 + v0, Is.EqualTo(3 * v0));
        }
        {
            var v0 = new vec2(-3f, 6f);
            Assert.That(v0 + v0 + v0, Is.EqualTo(3 * v0));
        }
        {
    ...
    public void InvariantCommutative()
    {
        ...
        }
        {
            ...
            var v1 = new vec2(4f, 8.5f);
            Assert.That(v0 * v1, Is.EqualTo(v1 * v0));
        }
        {
            var v0 = new vec2(-1f, 7f);
            var v1 = new vec2(-6f, 9.5f);
            Assert.That(v0 * v1, Is.EqualTo(v1 * v0));
        }
        {
            var v0 = new vec2(7f, -8.5f);
            var v1 = new vec2(-5f, 7.5f);
            Assert.That(v0 * v1, Is.EqualTo(v1 * v0));
        }
        {
        ...
        {
            var v0 = new vec2(7f, 3.5f);
            var v1 = new vec2(0f, -1f);
            Assert.That(v0 * v1, Is.EqualTo(v1 * v0));
        }
        {
            var v0 = new vec2(5f, -8.5f);
            var v1 = new vec2(-2f, 6f);
            Assert.That(v0 * v1, Is.EqualTo(v1 * v0));
        }
        {
            var v0 = new vec2(5f, -5.5f);
    ...
    public void InvariantAssociative()
    {
        ...
        }
        {
            ...
            var v2 = new vec2(-5f, -5f);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new vec2(1.5f, -6f);
            var v1 = new vec2(-2f, 0.5f);
            var v2 = new vec2(-9.5f, 0f);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new vec2(6.5f, -7f);
            var v1 = new vec2(9f, -4f);
            var v2 = new vec2(-2f, 3f);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new vec2(4.5f, -9f);
            var v1 = new vec2(-3.5f, -5.5f);
            var v2 = new vec2(0.5f, -8f);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new vec2(-6f, -5f);
            var v1 = new vec2(-7.5f, 4.5f);
            var v2 = new vec2(2f, 1f);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new vec2(-5.5f, -7.5f);
            var v1 = new vec2(0f, -3.5f);
            var v2 = new vec2(0f, 9f);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new vec2(-7.5f, 2f);
            var v1 = new vec2(8f, -8.5f);
            var v2 = new vec2(5.5f, 0.5f);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new vec2(-1.5f, 7.5f);
            var v1 = new vec2(-7.5f, -4f);
            var v2 = new vec2(-4.5f, -7.5f);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
    }
    ...
    {
        {
            var v0 = new vec2(-8.5f, -8.5f);
            Assert.That(v0, Is.EqualTo(-(-v0)));
        }
        {
            var v0 = new vec2(-3f, 2f);
            Assert.That(v0, Is.EqualTo(-(-v0)));
        }
        {
    ...
    {
        {
            ...
            var v1 = new vec2(9f, -5f);
            var v2 = new vec2(-3.5f, 6f);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
            var v0 = new vec2(2f, -6.5f);
            var v1 = new vec2(2.5f, -7.5f);
            var v2 = new vec2(7f, 5.5f);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
            var v0 = new vec2(-7.5f, 6f);
            var v1 = new vec2(-2f, 3.5f);
            var v2 = new vec2(0f, 4f);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
            var v0 = new vec2(-3.5f, 6f);
            var v1 = new vec2(7f, -2.5f);
            var v2 = new vec2(2.5f, -1f);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
            var v0 = new vec2(-4.5f, 8.5f);
            var v1 = new vec2(-4f, 3.5f);
            var v2 = new vec2(-1f, -3.5f);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
            var v0 = new vec2(4.5f, -1f);
            var v1 = new vec2(4.5f, 5f);
            var v2 = new vec2(6f, 1f);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
            var v0 = new vec2(2.5f, -4.5f);
        ...
        }
        {
            ...
            var v1 = new vec2(9f, 5f);
            var v2 = new vec2(7.5f, -0.5f);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
            var v0 = new vec2(9.5f, -2f);
            var v1 = new vec2(-1.5f, 5f);
            var v2 = new vec2(-6f, 0f);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
            var v0 = new vec2(4.5f, -6f);
            var v1 = new vec2(-1f, 8.5f);
    ...
    public void TriangleInequality()
    {
        ...
        {
            var v0 = new vec2(-7f, 1.5f);
            var v1 = new vec2(-2f, -9.5f);
            Assert.That(v0.NormMax + v1.NormMax, Is.GreaterThanOrEqualTo((v0 + v1).NormMax));
        }
        {
            var v0 = new vec2(7.5f, 3.5f);
            var v1 = new vec2(-9.5f, -9.5f);
            Assert.That(v0.NormMax + v1.NormMax, Is.GreaterThanOrEqualTo((v0 + v1).NormMax));
        }
        {
            var v0 = new vec2(-9f, -8f);
    ...
    public void InvariantNorm()
    {
        ...
        {
            var v0 = new vec2(9f, 5.5f);
            Assert.That(v0.NormMax, Is.LessThanOrEqualTo(v0.Norm));
        }
        {
            var v0 = new vec2(-1.5f, -0.5f);
            Assert.That(v0.NormMax, Is.LessThanOrEqualTo(v0.Norm));
        }
        {
        ...
        {
            var v0 = new vec2(-4f, -4.5f);
            Assert.That(v0.NormMax, Is.LessThanOrEqualTo(v0.Norm));
        }
        {
            var v0 = new vec2(-2.5f, 0f);
            Assert.That(v0.NormMax, Is.LessThanOrEqualTo(v0.Norm));
        }
        {
            var v0 = new vec2(-0.5f, 3f);
            Assert.That(v0.NormMax, Is.LessThanOrEqualTo(v0.Norm));
        }
        {
            var v0 = new vec2(-2f, -2.5f);
            Assert.That(v0.NormMax, Is.LessThanOrEqualTo(v0.Norm));
        }
    }
    ...
    {
        var random = new Random(1146244110);
    ...
    {
        var random = new Random(1003469014);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = vec2.RandomUniform(random, (-1), (1));
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
    ...
    {
        var random = new Random(889932200);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(1524080076);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(1566498296);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = vec2.RandomNormal(random, 0.08538358941924917f, 8.178378468462443f);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(0.08538358941924917).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(0.08538358941924917).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(8.178378468462443).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(8.178378468462443).Within(3.0));
    }

    [Test]
    public void RandomGaussian1()
    {
        var random = new Random(874988561);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = vec2.RandomGaussian(random, -1.2184649087574635f, 3.9579048864347417f);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(-1.2184649087574635).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(-1.2184649087574635).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(3.9579048864347417).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(3.9579048864347417).Within(3.0));
    }

    [Test]
    public void RandomGaussian2()
    {
        var random = new Random(1186990430);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = vec2.RandomNormal(random, 0.36234092077349356f, 0.3283666588032463f);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(0.36234092077349356).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(0.36234092077349356).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(0.3283666588032463).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(0.3283666588032463).Within(3.0));
    }

    [Test]
    public void RandomGaussian3()
    {
        var random = new Random(110509782);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = vec2.RandomGaussian(random, -1.3696287923351065f, 8.920790957715731f);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(-1.3696287923351065).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(-1.3696287923351065).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(8.920790957715731).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(8.920790957715731).Within(3.0));
    }

    [Test]
    public void RandomGaussian4()
    {
        var random = new Random(2089107878);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = vec2.RandomNormal(random, -1.9716935604678902f, 4.769597116284816f);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(-1.9716935604678902).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(-1.9716935604678902).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(4.769597116284816).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(4.769597116284816).Within(3.0));
    }

    [Test]
    public void RandomNormal0()
    {
        var random = new Random(22482884);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(268400260);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(1882695950);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(2057884518);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(1294842368);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
