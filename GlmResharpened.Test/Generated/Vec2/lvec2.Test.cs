...
public class LongVec2Test
{
    ...
    public void Constructors()
    {
        ...
        {
            var v = new lvec2(6L, 8L);
            Assert.That(6L, Is.EqualTo(v.x));
            Assert.That(8L, Is.EqualTo(v.y));
        }
        {
            var v = new lvec2(new lvec2(4L, 8L));
            Assert.That(4L, Is.EqualTo(v.x));
            Assert.That(8L, Is.EqualTo(v.y));
        }
        {
            var v = new lvec2(new lvec3(-9L, 1, -7L));
            Assert.That(-9L, Is.EqualTo(v.x));
            Assert.That(1, Is.EqualTo(v.y));
        }
        {
            var v = new lvec2(new lvec4(-3L, -3L, 2L, 2L));
    ...
    {
        var v = new lvec2(-7L, -3L);
        var vals = v.Values;
        Assert.That(-7L, Is.EqualTo(vals[0]));
    ...
    public void Operators()
    {
        ...
        var v2 = new lvec2(4L, 2L);
        var v3 = new lvec2(2L, 4L);
    ...
    public void InvariantAssociative()
    {
        ...
        }
        {
            ...
            var v2 = new lvec2(1, -2L);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new lvec2(9L, -5L);
            var v1 = new lvec2(-4L, 2L);
            var v2 = new lvec2(0, -9L);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
    }
    ...
    {
        var random = new Random(2127595126);
    ...
    {
        var random = new Random(377510568);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomUniform(random, (-5), (-2));
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
    ...
    {
        var random = new Random(903698680);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(1560064032);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomUniform(random, (-2), (2));
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
    ...
    {
        var random = new Random(249789750);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(1731208404);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomPoisson(random, 2.354531207519831);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(2.354531207519831).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(2.354531207519831).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(2.354531207519831).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(2.354531207519831).Within(3.0));
    }

    [Test]
    public void RandomPoisson1()
    {
        var random = new Random(146099304);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomPoisson(random, 0.8643493141812968);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(0.8643493141812968).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(0.8643493141812968).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(0.8643493141812968).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(0.8643493141812968).Within(3.0));
    }

    [Test]
    public void RandomPoisson2()
    {
        var random = new Random(550905516);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomPoisson(random, 3.1187416392465783);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(3.1187416392465783).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(3.1187416392465783).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(3.1187416392465783).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(3.1187416392465783).Within(3.0));
    }

    [Test]
    public void RandomPoisson3()
    {
        var random = new Random(1006603746);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomPoisson(random, 1.830639435132332);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(1.830639435132332).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(1.830639435132332).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(1.830639435132332).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(1.830639435132332).Within(3.0));
    }

    [Test]
    public void RandomPoisson4()
    {
        var random = new Random(1110434256);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomPoisson(random, 1.7361769705247958);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(1.7361769705247958).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(1.7361769705247958).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(1.7361769705247958).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(1.7361769705247958).Within(3.0));
    }
