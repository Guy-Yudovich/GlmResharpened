...
public class LongVec2Test
{
    ...
    public void Operators()
    {
        ...
        var v2 = new lvec2(-6L, 9L);
        var v3 = new lvec2(9L, -6L);
        Assert.That((v1 == new lvec2(v1)).AllTrue);
        Assert.That((v2 == new lvec2(v2)).AllTrue);
        Assert.That((v3 == new lvec2(v3)).AllTrue);
    ...
    public void InvariantAssociative()
    {
        ...
        }
        {
            ...
            var v2 = new lvec2(-9L, 8L);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new lvec2(-8L, -4L);
            var v1 = new lvec2(9L, 6L);
            var v2 = new lvec2(3L, 0);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
        ...
        }
        {
            ...
            var v2 = new lvec2(9L, 9L);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new lvec2(-4L, 2L);
            var v1 = new lvec2(-2L, 0);
            var v2 = new lvec2(-4L, 8L);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
    ...
    public void TriangleInequality()
    {
        ...
        {
            var v0 = new lvec2(-8L, -1L);
            var v1 = new lvec2(-7L, -4L);
            Assert.That(v0.NormMax + v1.NormMax, Is.GreaterThanOrEqualTo((v0 + v1).NormMax));
        }
        {
            var v0 = new lvec2(-8L, 5L);
            var v1 = new lvec2(-1L, 4L);
            Assert.That(v0.NormMax + v1.NormMax, Is.GreaterThanOrEqualTo((v0 + v1).NormMax));
        }
        {
            var v0 = new lvec2(-4L, 9L);
    ...
    {
        var random = new Random(1896535169);
    ...
    {
        var random = new Random(1053499564);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomUniform(random, (3), (6));
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
    ...
    {
        var random = new Random(1589826031);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(1604281237);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomUniform(random, (4), (8));
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
    ...
    {
        var random = new Random(1106478537);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(298202444);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomPoisson(random, 1.7837558366748298);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(1.7837558366748298).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(1.7837558366748298).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(1.7837558366748298).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(1.7837558366748298).Within(3.0));
    }

    [Test]
    public void RandomPoisson1()
    {
        var random = new Random(1453909717);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomPoisson(random, 2.5229668049248715);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(2.5229668049248715).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(2.5229668049248715).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(2.5229668049248715).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(2.5229668049248715).Within(3.0));
    }

    [Test]
    public void RandomPoisson2()
    {
        var random = new Random(181203262);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomPoisson(random, 0.836038164950925);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(0.836038164950925).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(0.836038164950925).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(0.836038164950925).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(0.836038164950925).Within(3.0));
    }

    [Test]
    public void RandomPoisson3()
    {
        var random = new Random(402438290);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomPoisson(random, 1.8624843472440187);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(1.8624843472440187).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(1.8624843472440187).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(1.8624843472440187).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(1.8624843472440187).Within(3.0));
    }

    [Test]
    public void RandomPoisson4()
    {
        var random = new Random(898827396);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomPoisson(random, 2.873504723596156);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(2.873504723596156).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(2.873504723596156).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(2.873504723596156).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(2.873504723596156).Within(3.0));
    }
