...
public class LongVec2Test
{
    ...
    public void InvariantAssociative()
    {
        ...
        }
        {
            ...
            var v2 = new lvec2(6L, 0);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
        {
            var v0 = new lvec2(1, 8L);
            var v1 = new lvec2(-1L, 4L);
            var v2 = new lvec2(6L, 8L);
            Assert.That(v0 * (v1 + v2), Is.EqualTo(v0 * v1 + v0 * v2));
        }
    }
    ...
    public void InvariantAssociativeNeg()
    {
        ...
        }
        {
            ...
            var v2 = new lvec2(-5L, 0);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
            var v0 = new lvec2(3L, 8L);
            var v1 = new lvec2(4L, -3L);
            var v2 = new lvec2(6L, -1L);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
            var v0 = new lvec2(5L, -9L);
        ...
        }
        {
            ...
            var v1 = new lvec2(-5L, -3L);
            var v2 = new lvec2(5L, -1L);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
        {
            var v0 = new lvec2(-1L, 5L);
            var v1 = new lvec2(3L, 1);
            var v2 = new lvec2(-9L, -3L);
            Assert.That(v0 * (v1 - v2), Is.EqualTo(v0 * v1 - v0 * v2));
        }
    }
    ...
    {
        var random = new Random(1204627264);
    ...
    {
        var random = new Random(832874140);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomUniform(random, (-2), (3));
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
    ...
    {
        var random = new Random(194698980);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(1460939174);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomUniform(random, (-1), (3));
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
    ...
    {
        var random = new Random(826791298);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
    ...
    {
        var random = new Random(1452903870);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomPoisson(random, 1.4390046400665326);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(1.4390046400665326).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(1.4390046400665326).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(1.4390046400665326).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(1.4390046400665326).Within(3.0));
    }

    [Test]
    public void RandomPoisson1()
    {
        var random = new Random(316875981);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomPoisson(random, 2.359666173746654);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(2.359666173746654).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(2.359666173746654).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(2.359666173746654).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(2.359666173746654).Within(3.0));
    }

    [Test]
    public void RandomPoisson2()
    {
        var random = new Random(1060135513);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomPoisson(random, 1.1040661207419196);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(1.1040661207419196).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(1.1040661207419196).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(1.1040661207419196).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(1.1040661207419196).Within(3.0));
    }

    [Test]
    public void RandomPoisson3()
    {
        var random = new Random(1247684909);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomPoisson(random, 2.1628655608104848);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(2.1628655608104848).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(2.1628655608104848).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(2.1628655608104848).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(2.1628655608104848).Within(3.0));
    }

    [Test]
    public void RandomPoisson4()
    {
        var random = new Random(1704431664);
        var sum = new dvec2(0.0);
        var sumSqr = new dvec2(0.0);
        ...
        for (var _ = 0; _ < count; ++_)
        {
            var v = lvec2.RandomPoisson(random, 0.8771593069551323);
            sum += (dvec2)v;
            sumSqr += glm.Pow2((dvec2)v);
        }
        ...
        Assert.That(avg.x, Is.EqualTo(0.8771593069551323).Within(1.0));
        Assert.That(avg.y, Is.EqualTo(0.8771593069551323).Within(1.0));
        
        Assert.That(variance.x, Is.EqualTo(0.8771593069551323).Within(3.0));
        Assert.That(variance.y, Is.EqualTo(0.8771593069551323).Within(3.0));
    }
