...
public struct uvec4 : IReadOnlyList<uint>, IEquatable<uvec4>
{
    ...
    /// </summary>
    public uint Length => (uint)Math.Sqrt(((x*x + y*y) + (z*z + w*w)));
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public uint LengthSqr => (uint)((x*x + y*y) + (z*z + w*w));
    ...
    /// </summary>
    public uint Norm => (uint)Math.Sqrt(((x*x + y*y) + (z*z + w*w)));
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public uint Norm1 => ((x + y) + (z + w));
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public uint Norm2 => (uint)Math.Sqrt(((x*x + y*y) + (z*z + w*w)));
    
    /// <summary>
    /// Returns the max-norm of this vector.
    /// </summary>
    public uint NormMax => Math.Max(Math.Max(x, y), Math.Max(z, w));
    #endregion
    ...
    /// </summary>
    public static uint Distance(uvec4 lhs, uvec4 rhs) => (lhs - rhs).Length;
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static uint DistanceSqr(uvec4 lhs, uvec4 rhs) => (lhs - rhs).LengthSqr;
