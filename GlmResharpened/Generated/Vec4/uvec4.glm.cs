...
public static partial class glm
{
    ...
    /// </summary>
    public static uint Length(uvec4 v) => v.Length;
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public static uint LengthSqr(uvec4 v) => v.LengthSqr;
    ...
    /// </summary>
    public static uint Norm(uvec4 v) => v.Norm;
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public static uint Norm1(uvec4 v) => v.Norm1;
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public static uint Norm2(uvec4 v) => v.Norm2;
    
    /// <summary>
    /// Returns the max-norm of this vector.
    /// </summary>
    public static uint NormMax(uvec4 v) => v.NormMax;
    ...
    /// </summary>
    public static uint Distance(uvec4 lhs, uvec4 rhs) => uvec4.Distance(lhs, rhs);
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static uint DistanceSqr(uvec4 lhs, uvec4 rhs) => uvec4.DistanceSqr(lhs, rhs);
