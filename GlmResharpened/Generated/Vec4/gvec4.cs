...
public struct gvec4<T> : IReadOnlyList<T>, IEquatable<gvec4<T>>
{
    ...
    /// <summary>
    /// Returns a bvec4 from component-wise application of operator == (EqualityComparer&lt;T&gt;.Default.Equals(lhs, rhs)).
    /// </summary>
    public static bvec4 operator ==(gvec4<T> lhs, gvec4<T> rhs) => new bvec4(EqualityComparer<T>.Default.Equals(lhs.x, rhs.x), EqualityComparer<T>.Default.Equals(lhs.y, rhs.y), EqualityComparer<T>.Default.Equals(lhs.z, rhs.z), EqualityComparer<T>.Default.Equals(lhs.w, rhs.w));
    
    /// <summary>
    /// Returns a bvec4 from component-wise application of operator == (EqualityComparer&lt;T&gt;.Default.Equals(lhs, rhs)).
    /// </summary>
    public static bvec4 operator ==(gvec4<T> lhs, T rhs) => new bvec4(EqualityComparer<T>.Default.Equals(lhs.x, rhs), EqualityComparer<T>.Default.Equals(lhs.y, rhs), EqualityComparer<T>.Default.Equals(lhs.z, rhs), EqualityComparer<T>.Default.Equals(lhs.w, rhs));
    
    /// <summary>
    /// Returns a bvec4 from component-wise application of operator == (EqualityComparer&lt;T&gt;.Default.Equals(lhs, rhs)).
    /// </summary>
    public static bvec4 operator ==(T lhs, gvec4<T> rhs) => new bvec4(EqualityComparer<T>.Default.Equals(lhs, rhs.x), EqualityComparer<T>.Default.Equals(lhs, rhs.y), EqualityComparer<T>.Default.Equals(lhs, rhs.z), EqualityComparer<T>.Default.Equals(lhs, rhs.w));
