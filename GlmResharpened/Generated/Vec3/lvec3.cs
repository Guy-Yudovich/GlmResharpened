...
public struct lvec3 : IReadOnlyList<long>, IEquatable<lvec3>
{
    ...
    /// </summary>
    public long Length => (long)Math.Sqrt(((x*x + y*y) + z*z));
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public long LengthSqr => (long)((x*x + y*y) + z*z);
    ...
    /// </summary>
    public long Norm => (long)Math.Sqrt(((x*x + y*y) + z*z));
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public long Norm1 => ((Math.Abs(x) + Math.Abs(y)) + Math.Abs(z));
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public long Norm2 => (long)Math.Sqrt(((x*x + y*y) + z*z));
    ...
    /// </summary>
    public static long Distance(lvec3 lhs, lvec3 rhs) => (lhs - rhs).Length;
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static long DistanceSqr(lvec3 lhs, lvec3 rhs) => (lhs - rhs).LengthSqr;
