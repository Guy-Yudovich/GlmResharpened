...
public static partial class glm
{
    ...
    /// </summary>
    public static uint Length(uvec3 v) => v.Length;
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public static uint LengthSqr(uvec3 v) => v.LengthSqr;
    ...
    /// </summary>
    public static uint Norm(uvec3 v) => v.Norm;
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public static uint Norm1(uvec3 v) => v.Norm1;
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public static uint Norm2(uvec3 v) => v.Norm2;
    
    /// <summary>
    /// Returns the max-norm of this vector.
    /// </summary>
    public static uint NormMax(uvec3 v) => v.NormMax;
    ...
    /// </summary>
    public static uint Distance(uvec3 lhs, uvec3 rhs) => uvec3.Distance(lhs, rhs);
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static uint DistanceSqr(uvec3 lhs, uvec3 rhs) => uvec3.DistanceSqr(lhs, rhs);
