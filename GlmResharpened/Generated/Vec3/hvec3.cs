...
public struct hvec3 : IReadOnlyList<Half>, IEquatable<hvec3>
{
    ...
    /// </summary>
    public Half Length => (Half)Math.Sqrt((double)((x*x + y*y) + z*z));
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public Half LengthSqr => (Half)((x*x + y*y) + z*z);
    ...
    /// </summary>
    public Half Norm => (Half)Math.Sqrt((double)((x*x + y*y) + z*z));
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public Half Norm1 => ((Half.Abs(x) + Half.Abs(y)) + Half.Abs(z));
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public Half Norm2 => (Half)Math.Sqrt((double)((x*x + y*y) + z*z));
    
    /// <summary>
    /// Returns the max-norm of this vector.
    /// </summary>
    public Half NormMax => Half.Max(Half.Max(Half.Abs(x), Half.Abs(y)), Half.Abs(z));
    ...
    /// </summary>
    public static bool ApproxEqual(hvec3 lhs, hvec3 rhs, float eps = 0.1f) => (float)Distance(lhs, rhs) <= eps;
    ...
    /// </summary>
    public static Half Distance(hvec3 lhs, hvec3 rhs) => (lhs - rhs).Length;
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static Half DistanceSqr(hvec3 lhs, hvec3 rhs) => (lhs - rhs).LengthSqr;
    
    /// <summary>
    /// Calculate the reflection direction for an incident vector (N should be normalized in order to achieve the desired result).
    /// </summary>
    public static hvec3 Reflect(hvec3 I, hvec3 N) => I - (byte)2 * Dot(N, I) * N;
    ...
    /// </summary>
    public static hvec3 FaceForward(hvec3 N, hvec3 I, hvec3 Nref) => Dot(Nref, I) < (byte)0 ? N : -N;
    ...
    /// <summary>
    /// Returns a hvec3 from component-wise application of HermiteInterpolationOrder3 (((byte)3 - (byte)2 * v) * v * v).
    /// </summary>
    public static hvec3 HermiteInterpolationOrder3(hvec3 v) => new hvec3(((byte)3 - (byte)2 * v.x) * v.x * v.x, ((byte)3 - (byte)2 * v.y) * v.y * v.y, ((byte)3 - (byte)2 * v.z) * v.z * v.z);
    
    /// <summary>
    /// Returns a hvec from the application of HermiteInterpolationOrder3 (((byte)3 - (byte)2 * v) * v * v).
    /// </summary>
    public static hvec3 HermiteInterpolationOrder3(Half v) => new hvec3(((byte)3 - (byte)2 * v) * v * v);
    
    /// <summary>
    /// Returns a hvec3 from component-wise application of HermiteInterpolationOrder5 ((((byte)6 * v - (byte)15) * v + (byte)10) * v * v * v).
    /// </summary>
    public static hvec3 HermiteInterpolationOrder5(hvec3 v) => new hvec3((((byte)6 * v.x - (byte)15) * v.x + (byte)10) * v.x * v.x * v.x, (((byte)6 * v.y - (byte)15) * v.y + (byte)10) * v.y * v.y * v.y, (((byte)6 * v.z - (byte)15) * v.z + (byte)10) * v.z * v.z * v.z);
    
    /// <summary>
    /// Returns a hvec from the application of HermiteInterpolationOrder5 ((((byte)6 * v - (byte)15) * v + (byte)10) * v * v * v).
    /// </summary>
    public static hvec3 HermiteInterpolationOrder5(Half v) => new hvec3((((byte)6 * v - (byte)15) * v + (byte)10) * v * v * v);
    ...
    /// <summary>
    /// Returns a ivec3 from component-wise application of Sign (Math.Sign((double)v)).
    /// </summary>
    public static ivec3 Sign(hvec3 v) => new ivec3(Math.Sign((double)v.x), Math.Sign((double)v.y), Math.Sign((double)v.z));
    
    /// <summary>
    /// Returns a ivec from the application of Sign (Math.Sign((double)v)).
    /// </summary>
    public static ivec3 Sign(Half v) => new ivec3(Math.Sign((double)v));
    ...
    /// <summary>
    /// Returns a hvec3 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec3 Mix(hvec3 min, hvec3 max, hvec3 a) => new hvec3(min.x * ((byte)1-a.x) + max.x * a.x, min.y * ((byte)1-a.y) + max.y * a.y, min.z * ((byte)1-a.z) + max.z * a.z);
    
    /// <summary>
    /// Returns a hvec3 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec3 Mix(hvec3 min, hvec3 max, Half a) => new hvec3(min.x * ((byte)1-a) + max.x * a, min.y * ((byte)1-a) + max.y * a, min.z * ((byte)1-a) + max.z * a);
    
    /// <summary>
    /// Returns a hvec3 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec3 Mix(hvec3 min, Half max, hvec3 a) => new hvec3(min.x * ((byte)1-a.x) + max * a.x, min.y * ((byte)1-a.y) + max * a.y, min.z * ((byte)1-a.z) + max * a.z);
    
    /// <summary>
    /// Returns a hvec3 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec3 Mix(hvec3 min, Half max, Half a) => new hvec3(min.x * ((byte)1-a) + max * a, min.y * ((byte)1-a) + max * a, min.z * ((byte)1-a) + max * a);
    
    /// <summary>
    /// Returns a hvec3 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec3 Mix(Half min, hvec3 max, hvec3 a) => new hvec3(min * ((byte)1-a.x) + max.x * a.x, min * ((byte)1-a.y) + max.y * a.y, min * ((byte)1-a.z) + max.z * a.z);
    
    /// <summary>
    /// Returns a hvec3 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec3 Mix(Half min, hvec3 max, Half a) => new hvec3(min * ((byte)1-a) + max.x * a, min * ((byte)1-a) + max.y * a, min * ((byte)1-a) + max.z * a);
    
    /// <summary>
    /// Returns a hvec3 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec3 Mix(Half min, Half max, hvec3 a) => new hvec3(min * ((byte)1-a.x) + max * a.x, min * ((byte)1-a.y) + max * a.y, min * ((byte)1-a.z) + max * a.z);
    
    /// <summary>
    /// Returns a hvec from the application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec3 Mix(Half min, Half max, Half a) => new hvec3(min * ((byte)1-a) + max * a);
    
    /// <summary>
    /// Returns a hvec3 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec3 Lerp(hvec3 min, hvec3 max, hvec3 a) => new hvec3(min.x * ((byte)1-a.x) + max.x * a.x, min.y * ((byte)1-a.y) + max.y * a.y, min.z * ((byte)1-a.z) + max.z * a.z);
    
    /// <summary>
    /// Returns a hvec3 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec3 Lerp(hvec3 min, hvec3 max, Half a) => new hvec3(min.x * ((byte)1-a) + max.x * a, min.y * ((byte)1-a) + max.y * a, min.z * ((byte)1-a) + max.z * a);
    
    /// <summary>
    /// Returns a hvec3 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec3 Lerp(hvec3 min, Half max, hvec3 a) => new hvec3(min.x * ((byte)1-a.x) + max * a.x, min.y * ((byte)1-a.y) + max * a.y, min.z * ((byte)1-a.z) + max * a.z);
    
    /// <summary>
    /// Returns a hvec3 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec3 Lerp(hvec3 min, Half max, Half a) => new hvec3(min.x * ((byte)1-a) + max * a, min.y * ((byte)1-a) + max * a, min.z * ((byte)1-a) + max * a);
    
    /// <summary>
    /// Returns a hvec3 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec3 Lerp(Half min, hvec3 max, hvec3 a) => new hvec3(min * ((byte)1-a.x) + max.x * a.x, min * ((byte)1-a.y) + max.y * a.y, min * ((byte)1-a.z) + max.z * a.z);
    
    /// <summary>
    /// Returns a hvec3 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec3 Lerp(Half min, hvec3 max, Half a) => new hvec3(min * ((byte)1-a) + max.x * a, min * ((byte)1-a) + max.y * a, min * ((byte)1-a) + max.z * a);
    
    /// <summary>
    /// Returns a hvec3 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec3 Lerp(Half min, Half max, hvec3 a) => new hvec3(min * ((byte)1-a.x) + max * a.x, min * ((byte)1-a.y) + max * a.y, min * ((byte)1-a.z) + max * a.z);
    
    /// <summary>
    /// Returns a hvec from the application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec3 Lerp(Half min, Half max, Half a) => new hvec3(min * ((byte)1-a) + max * a);
    ...
    /// </summary>
    public static hvec3 Degrees(hvec3 v) => new hvec3((Half)(v.x * ((Half)(57.295779513082320876798154814105170332405472466564321))), (Half)(v.y * ((Half)(57.295779513082320876798154814105170332405472466564321))), (Half)(v.z * ((Half)(57.295779513082320876798154814105170332405472466564321))));
    
    /// <summary>
    /// Returns a hvec from the application of Degrees (Radians-To-Degrees Conversion).
    /// </summary>
    public static hvec3 Degrees(Half v) => new hvec3((Half)(v * ((Half)(57.295779513082320876798154814105170332405472466564321))));
    
    /// <summary>
    /// Returns a hvec3 from component-wise application of Radians (Degrees-To-Radians Conversion).
    /// </summary>
    public static hvec3 Radians(hvec3 v) => new hvec3((Half)(v.x * ((Half)(0.0174532925199432957692369076848861271344287188854172))), (Half)(v.y * ((Half)(0.0174532925199432957692369076848861271344287188854172))), (Half)(v.z * ((Half)(0.0174532925199432957692369076848861271344287188854172))));
    
    /// <summary>
    /// Returns a hvec from the application of Radians (Degrees-To-Radians Conversion).
    /// </summary>
    public static hvec3 Radians(Half v) => new hvec3((Half)(v * ((Half)(0.0174532925199432957692369076848861271344287188854172))));
    ...
    /// <summary>
    /// Returns a hvec3 from component-wise application of Floor ((Half)Math.Floor((double)v)).
    /// </summary>
    public static hvec3 Floor(hvec3 v) => new hvec3((Half)Math.Floor((double)v.x), (Half)Math.Floor((double)v.y), (Half)Math.Floor((double)v.z));
    
    /// <summary>
    /// Returns a hvec from the application of Floor ((Half)Math.Floor((double)v)).
    /// </summary>
    public static hvec3 Floor(Half v) => new hvec3((Half)Math.Floor((double)v));
    
    /// <summary>
    /// Returns a hvec3 from component-wise application of Ceiling ((Half)Math.Ceiling((double)v)).
    /// </summary>
    public static hvec3 Ceiling(hvec3 v) => new hvec3((Half)Math.Ceiling((double)v.x), (Half)Math.Ceiling((double)v.y), (Half)Math.Ceiling((double)v.z));
    
    /// <summary>
    /// Returns a hvec from the application of Ceiling ((Half)Math.Ceiling((double)v)).
    /// </summary>
    public static hvec3 Ceiling(Half v) => new hvec3((Half)Math.Ceiling((double)v));
    
    /// <summary>
    /// Returns a hvec3 from component-wise application of Round ((Half)Math.Round((double)v)).
    /// </summary>
    public static hvec3 Round(hvec3 v) => new hvec3((Half)Math.Round((double)v.x), (Half)Math.Round((double)v.y), (Half)Math.Round((double)v.z));
    
    /// <summary>
    /// Returns a hvec from the application of Round ((Half)Math.Round((double)v)).
    /// </summary>
    public static hvec3 Round(Half v) => new hvec3((Half)Math.Round((double)v));
    ...
    /// <summary>
    /// Returns a hvec3 from component-wise application of Fract ((v - (Half)Math.Floor((double)v))).
    /// </summary>
    public static hvec3 Fract(hvec3 v) => new hvec3((v.x - (Half)Math.Floor((double)v.x)), (v.y - (Half)Math.Floor((double)v.y)), (v.z - (Half)Math.Floor((double)v.z)));
    
    /// <summary>
    /// Returns a hvec from the application of Fract ((v - (Half)Math.Floor((double)v))).
    /// </summary>
    public static hvec3 Fract(Half v) => new hvec3((v - (Half)Math.Floor((double)v)));
    
    /// <summary>
    /// Returns a hvec3 from component-wise application of Trunc ((Half)(long)(v)).
    /// </summary>
    public static hvec3 Trunc(hvec3 v) => new hvec3((Half)(long)(v.x), (Half)(long)(v.y), (Half)(long)(v.z));
    
    /// <summary>
    /// Returns a hvec from the application of Trunc ((Half)(long)(v)).
    /// </summary>
    public static hvec3 Trunc(Half v) => new hvec3((Half)(long)(v));
