...
public struct gvec3<T> : IReadOnlyList<T>, IEquatable<gvec3<T>>
{
    ...
    /// <summary>
    /// Returns a bvec3 from component-wise application of operator == (EqualityComparer&lt;T&gt;.Default.Equals(lhs, rhs)).
    /// </summary>
    public static bvec3 operator ==(gvec3<T> lhs, gvec3<T> rhs) => new bvec3(EqualityComparer<T>.Default.Equals(lhs.x, rhs.x), EqualityComparer<T>.Default.Equals(lhs.y, rhs.y), EqualityComparer<T>.Default.Equals(lhs.z, rhs.z));
    
    /// <summary>
    /// Returns a bvec3 from component-wise application of operator == (EqualityComparer&lt;T&gt;.Default.Equals(lhs, rhs)).
    /// </summary>
    public static bvec3 operator ==(gvec3<T> lhs, T rhs) => new bvec3(EqualityComparer<T>.Default.Equals(lhs.x, rhs), EqualityComparer<T>.Default.Equals(lhs.y, rhs), EqualityComparer<T>.Default.Equals(lhs.z, rhs));
    
    /// <summary>
    /// Returns a bvec3 from component-wise application of operator == (EqualityComparer&lt;T&gt;.Default.Equals(lhs, rhs)).
    /// </summary>
    public static bvec3 operator ==(T lhs, gvec3<T> rhs) => new bvec3(EqualityComparer<T>.Default.Equals(lhs, rhs.x), EqualityComparer<T>.Default.Equals(lhs, rhs.y), EqualityComparer<T>.Default.Equals(lhs, rhs.z));
