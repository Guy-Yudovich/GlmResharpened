...
public struct ivec3 : IReadOnlyList<int>, IEquatable<ivec3>
{
    ...
    /// </summary>
    public int LengthSqr => (int)((x*x + y*y) + z*z);
    ...
    /// </summary>
    public int Norm => (int)Math.Sqrt(((x*x + y*y) + z*z));
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public int Norm1 => ((Math.Abs(x) + Math.Abs(y)) + Math.Abs(z));
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public int Norm2 => (int)Math.Sqrt(((x*x + y*y) + z*z));
    ...
    /// </summary>
    public static int Distance(ivec3 lhs, ivec3 rhs) => (lhs - rhs).Length;
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static int DistanceSqr(ivec3 lhs, ivec3 rhs) => (lhs - rhs).LengthSqr;
