...
public static partial class glm
{
    ...
    /// </summary>
    public static long Length(lvec3 v) => v.Length;
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public static long LengthSqr(lvec3 v) => v.LengthSqr;
    ...
    /// </summary>
    public static long Norm(lvec3 v) => v.Norm;
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public static long Norm1(lvec3 v) => v.Norm1;
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public static long Norm2(lvec3 v) => v.Norm2;
    
    /// <summary>
    /// Returns the max-norm of this vector.
    /// </summary>
    public static long NormMax(lvec3 v) => v.NormMax;
    ...
    /// </summary>
    public static long Distance(lvec3 lhs, lvec3 rhs) => lvec3.Distance(lhs, rhs);
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static long DistanceSqr(lvec3 lhs, lvec3 rhs) => lvec3.DistanceSqr(lhs, rhs);
