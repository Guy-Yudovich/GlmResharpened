...
public struct cvec3 : IReadOnlyList<Complex>, IEquatable<cvec3>
{
    ...
    /// </summary>
    public Complex Length => (Complex)Math.Sqrt(((x.LengthSqr() + y.LengthSqr()) + z.LengthSqr()));
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public Complex LengthSqr => (Complex)((x.LengthSqr() + y.LengthSqr()) + z.LengthSqr());
    ...
    /// </summary>
    public Complex Norm => (Complex)Math.Sqrt(((x.LengthSqr() + y.LengthSqr()) + z.LengthSqr()));
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public Complex Norm1 => ((x.Magnitude + y.Magnitude) + z.Magnitude);
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public Complex Norm2 => (Complex)Math.Sqrt(((x.LengthSqr() + y.LengthSqr()) + z.LengthSqr()));
    ...
    /// </summary>
    public static Complex Distance(cvec3 lhs, cvec3 rhs) => (lhs - rhs).Length;
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static Complex DistanceSqr(cvec3 lhs, cvec3 rhs) => (lhs - rhs).LengthSqr;
    ...
    /// </summary>
    public static bvec3 operator ==(cvec3 lhs, cvec3 rhs) => new bvec3(lhs.x == rhs.x, lhs.y == rhs.y, lhs.z == rhs.z);
    
    /// <summary>
    /// Returns a bvec3 from component-wise application of operator == (lhs == rhs).
    /// </summary>
    public static bvec3 operator ==(cvec3 lhs, Complex rhs) => new bvec3(lhs.x == rhs, lhs.y == rhs, lhs.z == rhs);
    
    /// <summary>
    /// Returns a bvec3 from component-wise application of operator == (lhs == rhs).
    /// </summary>
    public static bvec3 operator ==(Complex lhs, cvec3 rhs) => new bvec3(lhs == rhs.x, lhs == rhs.y, lhs == rhs.z);
