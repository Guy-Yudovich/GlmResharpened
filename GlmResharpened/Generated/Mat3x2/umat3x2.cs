...
public struct umat3x2 : IReadOnlyList<uint>, IEquatable<umat3x2>
{
    ...
    /// </summary>
    public uint Length => (uint)Math.Sqrt((((m00*m00 + m01*m01) + m10*m10) + ((m11*m11 + m20*m20) + m21*m21)));
    
    /// <summary>
    /// Returns the squared euclidean length of this matrix.
    /// </summary>
    public uint LengthSqr => (((m00*m00 + m01*m01) + m10*m10) + ((m11*m11 + m20*m20) + m21*m21));
    ...
    /// </summary>
    public uint Norm => (uint)Math.Sqrt((((m00*m00 + m01*m01) + m10*m10) + ((m11*m11 + m20*m20) + m21*m21)));
    
    /// <summary>
    /// Returns the one-norm of this matrix.
    /// </summary>
    public uint Norm1 => (((m00 + m01) + m10) + ((m11 + m20) + m21));
    
    /// <summary>
    /// Returns the two-norm of this matrix.
    /// </summary>
    public uint Norm2 => (uint)Math.Sqrt((((m00*m00 + m01*m01) + m10*m10) + ((m11*m11 + m20*m20) + m21*m21)));
