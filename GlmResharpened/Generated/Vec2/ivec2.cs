...
public struct ivec2 : IReadOnlyList<int>, IEquatable<ivec2>
{
    ...
    /// </summary>
    public int LengthSqr => (int)(x*x + y*y);
    ...
    /// </summary>
    public int Norm1 => (Math.Abs(x) + Math.Abs(y));
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public int Norm2 => (int)Math.Sqrt((x*x + y*y));
    ...
    /// </summary>
    public static int Distance(ivec2 lhs, ivec2 rhs) => (lhs - rhs).Length;
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static int DistanceSqr(ivec2 lhs, ivec2 rhs) => (lhs - rhs).LengthSqr;
