...
public struct gvec2<T> : IReadOnlyList<T>, IEquatable<gvec2<T>>
{
    ...
    /// <summary>
    /// Returns a bvec2 from component-wise application of operator == (EqualityComparer&lt;T&gt;.Default.Equals(lhs, rhs)).
    /// </summary>
    public static bvec2 operator ==(gvec2<T> lhs, gvec2<T> rhs) => new bvec2(EqualityComparer<T>.Default.Equals(lhs.x, rhs.x), EqualityComparer<T>.Default.Equals(lhs.y, rhs.y));
    
    /// <summary>
    /// Returns a bvec2 from component-wise application of operator == (EqualityComparer&lt;T&gt;.Default.Equals(lhs, rhs)).
    /// </summary>
    public static bvec2 operator ==(gvec2<T> lhs, T rhs) => new bvec2(EqualityComparer<T>.Default.Equals(lhs.x, rhs), EqualityComparer<T>.Default.Equals(lhs.y, rhs));
    
    /// <summary>
    /// Returns a bvec2 from component-wise application of operator == (EqualityComparer&lt;T&gt;.Default.Equals(lhs, rhs)).
    /// </summary>
    public static bvec2 operator ==(T lhs, gvec2<T> rhs) => new bvec2(EqualityComparer<T>.Default.Equals(lhs, rhs.x), EqualityComparer<T>.Default.Equals(lhs, rhs.y));
