...
public struct hvec2 : IReadOnlyList<Half>, IEquatable<hvec2>
{
    ...
    /// </summary>
    public Half Length => (Half)Math.Sqrt((double)(x*x + y*y));
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public Half LengthSqr => (Half)(x*x + y*y);
    ...
    /// </summary>
    public Half Norm => (Half)Math.Sqrt((double)(x*x + y*y));
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public Half Norm1 => (Half.Abs(x) + Half.Abs(y));
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public Half Norm2 => (Half)Math.Sqrt((double)(x*x + y*y));
    
    /// <summary>
    /// Returns the max-norm of this vector.
    /// </summary>
    public Half NormMax => Half.Max(Half.Abs(x), Half.Abs(y));
    ...
    /// </summary>
    public static bool ApproxEqual(hvec2 lhs, hvec2 rhs, float eps = 0.1f) => (float)Distance(lhs, rhs) <= eps;
    ...
    /// </summary>
    public static Half Distance(hvec2 lhs, hvec2 rhs) => (lhs - rhs).Length;
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static Half DistanceSqr(hvec2 lhs, hvec2 rhs) => (lhs - rhs).LengthSqr;
    
    /// <summary>
    /// Calculate the reflection direction for an incident vector (N should be normalized in order to achieve the desired result).
    /// </summary>
    public static hvec2 Reflect(hvec2 I, hvec2 N) => I - (byte)2 * Dot(N, I) * N;
    ...
    /// </summary>
    public static hvec2 FaceForward(hvec2 N, hvec2 I, hvec2 Nref) => Dot(Nref, I) < (byte)0 ? N : -N;
    ...
    /// <summary>
    /// Returns a hvec2 from component-wise application of HermiteInterpolationOrder3 (((byte)3 - (byte)2 * v) * v * v).
    /// </summary>
    public static hvec2 HermiteInterpolationOrder3(hvec2 v) => new hvec2(((byte)3 - (byte)2 * v.x) * v.x * v.x, ((byte)3 - (byte)2 * v.y) * v.y * v.y);
    
    /// <summary>
    /// Returns a hvec from the application of HermiteInterpolationOrder3 (((byte)3 - (byte)2 * v) * v * v).
    /// </summary>
    public static hvec2 HermiteInterpolationOrder3(Half v) => new hvec2(((byte)3 - (byte)2 * v) * v * v);
    
    /// <summary>
    /// Returns a hvec2 from component-wise application of HermiteInterpolationOrder5 ((((byte)6 * v - (byte)15) * v + (byte)10) * v * v * v).
    /// </summary>
    public static hvec2 HermiteInterpolationOrder5(hvec2 v) => new hvec2((((byte)6 * v.x - (byte)15) * v.x + (byte)10) * v.x * v.x * v.x, (((byte)6 * v.y - (byte)15) * v.y + (byte)10) * v.y * v.y * v.y);
    
    /// <summary>
    /// Returns a hvec from the application of HermiteInterpolationOrder5 ((((byte)6 * v - (byte)15) * v + (byte)10) * v * v * v).
    /// </summary>
    public static hvec2 HermiteInterpolationOrder5(Half v) => new hvec2((((byte)6 * v - (byte)15) * v + (byte)10) * v * v * v);
    ...
    /// <summary>
    /// Returns a ivec2 from component-wise application of Sign (Math.Sign((double)v)).
    /// </summary>
    public static ivec2 Sign(hvec2 v) => new ivec2(Math.Sign((double)v.x), Math.Sign((double)v.y));
    
    /// <summary>
    /// Returns a ivec from the application of Sign (Math.Sign((double)v)).
    /// </summary>
    public static ivec2 Sign(Half v) => new ivec2(Math.Sign((double)v));
    ...
    /// <summary>
    /// Returns a hvec2 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec2 Mix(hvec2 min, hvec2 max, hvec2 a) => new hvec2(min.x * ((byte)1-a.x) + max.x * a.x, min.y * ((byte)1-a.y) + max.y * a.y);
    
    /// <summary>
    /// Returns a hvec2 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec2 Mix(hvec2 min, hvec2 max, Half a) => new hvec2(min.x * ((byte)1-a) + max.x * a, min.y * ((byte)1-a) + max.y * a);
    
    /// <summary>
    /// Returns a hvec2 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec2 Mix(hvec2 min, Half max, hvec2 a) => new hvec2(min.x * ((byte)1-a.x) + max * a.x, min.y * ((byte)1-a.y) + max * a.y);
    
    /// <summary>
    /// Returns a hvec2 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec2 Mix(hvec2 min, Half max, Half a) => new hvec2(min.x * ((byte)1-a) + max * a, min.y * ((byte)1-a) + max * a);
    
    /// <summary>
    /// Returns a hvec2 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec2 Mix(Half min, hvec2 max, hvec2 a) => new hvec2(min * ((byte)1-a.x) + max.x * a.x, min * ((byte)1-a.y) + max.y * a.y);
    
    /// <summary>
    /// Returns a hvec2 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec2 Mix(Half min, hvec2 max, Half a) => new hvec2(min * ((byte)1-a) + max.x * a, min * ((byte)1-a) + max.y * a);
    
    /// <summary>
    /// Returns a hvec2 from component-wise application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec2 Mix(Half min, Half max, hvec2 a) => new hvec2(min * ((byte)1-a.x) + max * a.x, min * ((byte)1-a.y) + max * a.y);
    
    /// <summary>
    /// Returns a hvec from the application of Mix (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec2 Mix(Half min, Half max, Half a) => new hvec2(min * ((byte)1-a) + max * a);
    
    /// <summary>
    /// Returns a hvec2 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec2 Lerp(hvec2 min, hvec2 max, hvec2 a) => new hvec2(min.x * ((byte)1-a.x) + max.x * a.x, min.y * ((byte)1-a.y) + max.y * a.y);
    
    /// <summary>
    /// Returns a hvec2 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec2 Lerp(hvec2 min, hvec2 max, Half a) => new hvec2(min.x * ((byte)1-a) + max.x * a, min.y * ((byte)1-a) + max.y * a);
    
    /// <summary>
    /// Returns a hvec2 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec2 Lerp(hvec2 min, Half max, hvec2 a) => new hvec2(min.x * ((byte)1-a.x) + max * a.x, min.y * ((byte)1-a.y) + max * a.y);
    
    /// <summary>
    /// Returns a hvec2 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec2 Lerp(hvec2 min, Half max, Half a) => new hvec2(min.x * ((byte)1-a) + max * a, min.y * ((byte)1-a) + max * a);
    
    /// <summary>
    /// Returns a hvec2 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec2 Lerp(Half min, hvec2 max, hvec2 a) => new hvec2(min * ((byte)1-a.x) + max.x * a.x, min * ((byte)1-a.y) + max.y * a.y);
    
    /// <summary>
    /// Returns a hvec2 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec2 Lerp(Half min, hvec2 max, Half a) => new hvec2(min * ((byte)1-a) + max.x * a, min * ((byte)1-a) + max.y * a);
    
    /// <summary>
    /// Returns a hvec2 from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec2 Lerp(Half min, Half max, hvec2 a) => new hvec2(min * ((byte)1-a.x) + max * a.x, min * ((byte)1-a.y) + max * a.y);
    
    /// <summary>
    /// Returns a hvec from the application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hvec2 Lerp(Half min, Half max, Half a) => new hvec2(min * ((byte)1-a) + max * a);
    ...
    /// </summary>
    public static hvec2 Degrees(hvec2 v) => new hvec2((Half)(v.x * ((Half)(57.295779513082320876798154814105170332405472466564321))), (Half)(v.y * ((Half)(57.295779513082320876798154814105170332405472466564321))));
    
    /// <summary>
    /// Returns a hvec from the application of Degrees (Radians-To-Degrees Conversion).
    /// </summary>
    public static hvec2 Degrees(Half v) => new hvec2((Half)(v * ((Half)(57.295779513082320876798154814105170332405472466564321))));
    
    /// <summary>
    /// Returns a hvec2 from component-wise application of Radians (Degrees-To-Radians Conversion).
    /// </summary>
    public static hvec2 Radians(hvec2 v) => new hvec2((Half)(v.x * ((Half)(0.0174532925199432957692369076848861271344287188854172))), (Half)(v.y * ((Half)(0.0174532925199432957692369076848861271344287188854172))));
    
    /// <summary>
    /// Returns a hvec from the application of Radians (Degrees-To-Radians Conversion).
    /// </summary>
    public static hvec2 Radians(Half v) => new hvec2((Half)(v * ((Half)(0.0174532925199432957692369076848861271344287188854172))));
    ...
    /// <summary>
    /// Returns a hvec2 from component-wise application of Floor ((Half)Math.Floor((double)v)).
    /// </summary>
    public static hvec2 Floor(hvec2 v) => new hvec2((Half)Math.Floor((double)v.x), (Half)Math.Floor((double)v.y));
    
    /// <summary>
    /// Returns a hvec from the application of Floor ((Half)Math.Floor((double)v)).
    /// </summary>
    public static hvec2 Floor(Half v) => new hvec2((Half)Math.Floor((double)v));
    
    /// <summary>
    /// Returns a hvec2 from component-wise application of Ceiling ((Half)Math.Ceiling((double)v)).
    /// </summary>
    public static hvec2 Ceiling(hvec2 v) => new hvec2((Half)Math.Ceiling((double)v.x), (Half)Math.Ceiling((double)v.y));
    
    /// <summary>
    /// Returns a hvec from the application of Ceiling ((Half)Math.Ceiling((double)v)).
    /// </summary>
    public static hvec2 Ceiling(Half v) => new hvec2((Half)Math.Ceiling((double)v));
    
    /// <summary>
    /// Returns a hvec2 from component-wise application of Round ((Half)Math.Round((double)v)).
    /// </summary>
    public static hvec2 Round(hvec2 v) => new hvec2((Half)Math.Round((double)v.x), (Half)Math.Round((double)v.y));
    
    /// <summary>
    /// Returns a hvec from the application of Round ((Half)Math.Round((double)v)).
    /// </summary>
    public static hvec2 Round(Half v) => new hvec2((Half)Math.Round((double)v));
    ...
    /// <summary>
    /// Returns a hvec2 from component-wise application of Fract ((v - (Half)Math.Floor((double)v))).
    /// </summary>
    public static hvec2 Fract(hvec2 v) => new hvec2((v.x - (Half)Math.Floor((double)v.x)), (v.y - (Half)Math.Floor((double)v.y)));
    
    /// <summary>
    /// Returns a hvec from the application of Fract ((v - (Half)Math.Floor((double)v))).
    /// </summary>
    public static hvec2 Fract(Half v) => new hvec2((v - (Half)Math.Floor((double)v)));
    
    /// <summary>
    /// Returns a hvec2 from component-wise application of Trunc ((Half)(long)(v)).
    /// </summary>
    public static hvec2 Trunc(hvec2 v) => new hvec2((Half)(long)(v.x), (Half)(long)(v.y));
    
    /// <summary>
    /// Returns a hvec from the application of Trunc ((Half)(long)(v)).
    /// </summary>
    public static hvec2 Trunc(Half v) => new hvec2((Half)(long)(v));
