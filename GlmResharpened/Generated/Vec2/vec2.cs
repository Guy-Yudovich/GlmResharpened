...
public struct vec2 : IReadOnlyList<float>, IEquatable<vec2>
{
    ...
    /// </summary>
    public float LengthSqr => (float)(x*x + y*y);
    ...
    /// </summary>
    public static bool ApproxEqual(vec2 lhs, vec2 rhs, float eps = 0.1f) => (float)Distance(lhs, rhs) <= eps;
    ...
    /// <summary>
    /// Returns a vec2 from component-wise application of Floor ((float)Math.Floor((double)v)).
    /// </summary>
    public static vec2 Floor(vec2 v) => new vec2((float)Math.Floor((double)v.x), (float)Math.Floor((double)v.y));
    
    /// <summary>
    /// Returns a vec from the application of Floor ((float)Math.Floor((double)v)).
    /// </summary>
    public static vec2 Floor(float v) => new vec2((float)Math.Floor((double)v));
    
    /// <summary>
    /// Returns a vec2 from component-wise application of Ceiling ((float)Math.Ceiling((double)v)).
    /// </summary>
    public static vec2 Ceiling(vec2 v) => new vec2((float)Math.Ceiling((double)v.x), (float)Math.Ceiling((double)v.y));
    
    /// <summary>
    /// Returns a vec from the application of Ceiling ((float)Math.Ceiling((double)v)).
    /// </summary>
    public static vec2 Ceiling(float v) => new vec2((float)Math.Ceiling((double)v));
    
    /// <summary>
    /// Returns a vec2 from component-wise application of Round ((float)Math.Round((double)v)).
    /// </summary>
    public static vec2 Round(vec2 v) => new vec2((float)Math.Round((double)v.x), (float)Math.Round((double)v.y));
    
    /// <summary>
    /// Returns a vec from the application of Round ((float)Math.Round((double)v)).
    /// </summary>
    public static vec2 Round(float v) => new vec2((float)Math.Round((double)v));
    ...
    /// <summary>
    /// Returns a vec2 from component-wise application of Fract ((v - (float)Math.Floor((double)v))).
    /// </summary>
    public static vec2 Fract(vec2 v) => new vec2((v.x - (float)Math.Floor((double)v.x)), (v.y - (float)Math.Floor((double)v.y)));
    
    /// <summary>
    /// Returns a vec from the application of Fract ((v - (float)Math.Floor((double)v))).
    /// </summary>
    public static vec2 Fract(float v) => new vec2((v - (float)Math.Floor((double)v)));
    
    /// <summary>
    /// Returns a vec2 from component-wise application of Trunc ((float)(long)(v)).
    /// </summary>
    public static vec2 Trunc(vec2 v) => new vec2((float)(long)(v.x), (float)(long)(v.y));
    
    /// <summary>
    /// Returns a vec from the application of Trunc ((float)(long)(v)).
    /// </summary>
    public static vec2 Trunc(float v) => new vec2((float)(long)(v));
