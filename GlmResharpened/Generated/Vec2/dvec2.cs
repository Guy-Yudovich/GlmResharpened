...
public struct dvec2 : IReadOnlyList<double>, IEquatable<dvec2>
{
    ...
    /// </summary>
    public double LengthSqr => (double)(x*x + y*y);
    ...
    /// </summary>
    public static bool ApproxEqual(dvec2 lhs, dvec2 rhs, double eps = 0.1d) => (double)Distance(lhs, rhs) <= eps;
    ...
    /// <summary>
    /// Returns a dvec2 from component-wise application of Floor ((double)Math.Floor((double)v)).
    /// </summary>
    public static dvec2 Floor(dvec2 v) => new dvec2((double)Math.Floor((double)v.x), (double)Math.Floor((double)v.y));
    
    /// <summary>
    /// Returns a dvec from the application of Floor ((double)Math.Floor((double)v)).
    /// </summary>
    public static dvec2 Floor(double v) => new dvec2((double)Math.Floor((double)v));
    
    /// <summary>
    /// Returns a dvec2 from component-wise application of Ceiling ((double)Math.Ceiling((double)v)).
    /// </summary>
    public static dvec2 Ceiling(dvec2 v) => new dvec2((double)Math.Ceiling((double)v.x), (double)Math.Ceiling((double)v.y));
    
    /// <summary>
    /// Returns a dvec from the application of Ceiling ((double)Math.Ceiling((double)v)).
    /// </summary>
    public static dvec2 Ceiling(double v) => new dvec2((double)Math.Ceiling((double)v));
    
    /// <summary>
    /// Returns a dvec2 from component-wise application of Round ((double)Math.Round((double)v)).
    /// </summary>
    public static dvec2 Round(dvec2 v) => new dvec2((double)Math.Round((double)v.x), (double)Math.Round((double)v.y));
    
    /// <summary>
    /// Returns a dvec from the application of Round ((double)Math.Round((double)v)).
    /// </summary>
    public static dvec2 Round(double v) => new dvec2((double)Math.Round((double)v));
    ...
    /// <summary>
    /// Returns a dvec2 from component-wise application of Fract ((v - (double)Math.Floor((double)v))).
    /// </summary>
    public static dvec2 Fract(dvec2 v) => new dvec2((v.x - (double)Math.Floor((double)v.x)), (v.y - (double)Math.Floor((double)v.y)));
    
    /// <summary>
    /// Returns a dvec from the application of Fract ((v - (double)Math.Floor((double)v))).
    /// </summary>
    public static dvec2 Fract(double v) => new dvec2((v - (double)Math.Floor((double)v)));
    
    /// <summary>
    /// Returns a dvec2 from component-wise application of Trunc ((double)(long)(v)).
    /// </summary>
    public static dvec2 Trunc(dvec2 v) => new dvec2((double)(long)(v.x), (double)(long)(v.y));
    
    /// <summary>
    /// Returns a dvec from the application of Trunc ((double)(long)(v)).
    /// </summary>
    public static dvec2 Trunc(double v) => new dvec2((double)(long)(v));
