...
public static partial class glm
{
    ...
    /// </summary>
    public static Complex Length(cvec2 v) => v.Length;
    
    /// <summary>
    /// Returns the squared euclidean length of this vector.
    /// </summary>
    public static Complex LengthSqr(cvec2 v) => v.LengthSqr;
    ...
    /// </summary>
    public static Complex Norm(cvec2 v) => v.Norm;
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public static Complex Norm1(cvec2 v) => v.Norm1;
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public static Complex Norm2(cvec2 v) => v.Norm2;
    
    /// <summary>
    /// Returns the max-norm of this vector.
    /// </summary>
    public static Complex NormMax(cvec2 v) => v.NormMax;
    ...
    /// </summary>
    public static Complex Distance(cvec2 lhs, cvec2 rhs) => cvec2.Distance(lhs, rhs);
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static Complex DistanceSqr(cvec2 lhs, cvec2 rhs) => cvec2.DistanceSqr(lhs, rhs);
