...
public struct uvec2 : IReadOnlyList<uint>, IEquatable<uvec2>
{
    ...
    /// </summary>
    public uint LengthSqr => (uint)(x*x + y*y);
    ...
    /// </summary>
    public uint Norm => (uint)Math.Sqrt((x*x + y*y));
    
    /// <summary>
    /// Returns the one-norm of this vector.
    /// </summary>
    public uint Norm1 => (x + y);
    
    /// <summary>
    /// Returns the two-norm (euclidean length) of this vector.
    /// </summary>
    public uint Norm2 => (uint)Math.Sqrt((x*x + y*y));
    ...
    /// </summary>
    public static uint Distance(uvec2 lhs, uvec2 rhs) => (lhs - rhs).Length;
    
    /// <summary>
    /// Returns the squared euclidean distance between the two vectors.
    /// </summary>
    public static uint DistanceSqr(uvec2 lhs, uvec2 rhs) => (lhs - rhs).LengthSqr;
