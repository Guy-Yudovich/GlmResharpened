...
public struct lmat3x4 : IReadOnlyList<long>, IEquatable<lmat3x4>
{
    ...
    /// </summary>
    public long Length => (long)Math.Sqrt(((((m00*m00 + m01*m01) + m02*m02) + ((m03*m03 + m10*m10) + m11*m11)) + (((m12*m12 + m13*m13) + m20*m20) + ((m21*m21 + m22*m22) + m23*m23))));
    
    /// <summary>
    /// Returns the squared euclidean length of this matrix.
    /// </summary>
    public long LengthSqr => ((((m00*m00 + m01*m01) + m02*m02) + ((m03*m03 + m10*m10) + m11*m11)) + (((m12*m12 + m13*m13) + m20*m20) + ((m21*m21 + m22*m22) + m23*m23)));
    ...
    /// </summary>
    public long Norm => (long)Math.Sqrt(((((m00*m00 + m01*m01) + m02*m02) + ((m03*m03 + m10*m10) + m11*m11)) + (((m12*m12 + m13*m13) + m20*m20) + ((m21*m21 + m22*m22) + m23*m23))));
    
    /// <summary>
    /// Returns the one-norm of this matrix.
    /// </summary>
    public long Norm1 => ((((Math.Abs(m00) + Math.Abs(m01)) + Math.Abs(m02)) + ((Math.Abs(m03) + Math.Abs(m10)) + Math.Abs(m11))) + (((Math.Abs(m12) + Math.Abs(m13)) + Math.Abs(m20)) + ((Math.Abs(m21) + Math.Abs(m22)) + Math.Abs(m23))));
    
    /// <summary>
    /// Returns the two-norm of this matrix.
    /// </summary>
    public long Norm2 => (long)Math.Sqrt(((((m00*m00 + m01*m01) + m02*m02) + ((m03*m03 + m10*m10) + m11*m11)) + (((m12*m12 + m13*m13) + m20*m20) + ((m21*m21 + m22*m22) + m23*m23))));
