...
public struct hmat2x3 : IReadOnlyList<Half>, IEquatable<hmat2x3>
{
    ...
    /// </summary>
    public Half Length => (Half)Math.Sqrt((double)(((m00*m00 + m01*m01) + m02*m02) + ((m10*m10 + m11*m11) + m12*m12)));
    
    /// <summary>
    /// Returns the squared euclidean length of this matrix.
    /// </summary>
    public Half LengthSqr => (((m00*m00 + m01*m01) + m02*m02) + ((m10*m10 + m11*m11) + m12*m12));
    ...
    /// </summary>
    public Half Norm => (Half)Math.Sqrt((double)(((m00*m00 + m01*m01) + m02*m02) + ((m10*m10 + m11*m11) + m12*m12)));
    
    /// <summary>
    /// Returns the one-norm of this matrix.
    /// </summary>
    public Half Norm1 => (((Half.Abs(m00) + Half.Abs(m01)) + Half.Abs(m02)) + ((Half.Abs(m10) + Half.Abs(m11)) + Half.Abs(m12)));
    
    /// <summary>
    /// Returns the two-norm of this matrix.
    /// </summary>
    public Half Norm2 => (Half)Math.Sqrt((double)(((m00*m00 + m01*m01) + m02*m02) + ((m10*m10 + m11*m11) + m12*m12)));
