...
public struct hquat : IReadOnlyList<Half>, IEquatable<hquat>
{
    ...
    public hvec3 Axis
    {
        ...
        {
            var s1 = (byte)1 - w * w;
            if (s1 < (byte)0) return hvec3.UnitZ;
            var s2 = (byte)1 / (Half)Math.Sqrt((double)s1);
    ...
    /// </summary>
    public hmat3 ToMat3 => new hmat3((byte)1 - (byte)2 * (y*y + z*z), (byte)2 * (x*y + w*z), (byte)2 * (x*z - w*y), (byte)2 * (x*y - w*z), (byte)1 - (byte)2 * (x*x + z*z), (byte)2 * (y*z + w*x), (byte)2 * (x*z + w*y), (byte)2 * (y*z - w*x), (byte)1 - (byte)2 * (x*x + y*y));
    ...
    {
        var c = hvec3.Cos(eulerAngle / (byte)2);
        var s = hvec3.Sin(eulerAngle / (byte)2);
    ...
    /// </summary>
    public static hquat Squad(hquat q1, hquat q2, hquat s1, hquat s2, Half h) => Mix(Mix(q1, q2, h), Mix(s1, s2, h), (byte)2 * ((byte)1 - h) * h);
    #endregion
    ...
    /// <summary>
    /// Returns a hquat from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hquat Lerp(hquat min, hquat max, hquat a) => new hquat(min.x * ((byte)1-a.x) + max.x * a.x, min.y * ((byte)1-a.y) + max.y * a.y, min.z * ((byte)1-a.z) + max.z * a.z, min.w * ((byte)1-a.w) + max.w * a.w);
    
    /// <summary>
    /// Returns a hquat from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hquat Lerp(hquat min, hquat max, Half a) => new hquat(min.x * ((byte)1-a) + max.x * a, min.y * ((byte)1-a) + max.y * a, min.z * ((byte)1-a) + max.z * a, min.w * ((byte)1-a) + max.w * a);
    
    /// <summary>
    /// Returns a hquat from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hquat Lerp(hquat min, Half max, hquat a) => new hquat(min.x * ((byte)1-a.x) + max * a.x, min.y * ((byte)1-a.y) + max * a.y, min.z * ((byte)1-a.z) + max * a.z, min.w * ((byte)1-a.w) + max * a.w);
    
    /// <summary>
    /// Returns a hquat from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hquat Lerp(hquat min, Half max, Half a) => new hquat(min.x * ((byte)1-a) + max * a, min.y * ((byte)1-a) + max * a, min.z * ((byte)1-a) + max * a, min.w * ((byte)1-a) + max * a);
    
    /// <summary>
    /// Returns a hquat from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hquat Lerp(Half min, hquat max, hquat a) => new hquat(min * ((byte)1-a.x) + max.x * a.x, min * ((byte)1-a.y) + max.y * a.y, min * ((byte)1-a.z) + max.z * a.z, min * ((byte)1-a.w) + max.w * a.w);
    
    /// <summary>
    /// Returns a hquat from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hquat Lerp(Half min, hquat max, Half a) => new hquat(min * ((byte)1-a) + max.x * a, min * ((byte)1-a) + max.y * a, min * ((byte)1-a) + max.z * a, min * ((byte)1-a) + max.w * a);
    
    /// <summary>
    /// Returns a hquat from component-wise application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hquat Lerp(Half min, Half max, hquat a) => new hquat(min * ((byte)1-a.x) + max * a.x, min * ((byte)1-a.y) + max * a.y, min * ((byte)1-a.z) + max * a.z, min * ((byte)1-a.w) + max * a.w);
    
    /// <summary>
    /// Returns a hquat from the application of Lerp (min * ((byte)1-a) + max * a).
    /// </summary>
    public static hquat Lerp(Half min, Half max, Half a) => new hquat(min * ((byte)1-a) + max * a);
    #endregion
