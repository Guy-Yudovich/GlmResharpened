...
{
	public static double LengthSqr(this Complex c) => c.Real * c.Real + c.Imaginary * c.Imaginary;
	...
	public static Half HermiteInterpolationOrder3(this Half v) => v * v * ((byte)3 - (byte)2 * v);
	...
	public static Half HermiteInterpolationOrder5(this Half v) => v * v * v * ((byte)6 * v * v - (byte)15 * v + (byte)10);
	...
	public static int GetPoisson(this double lambda, Random random) => (lambda < 30.0) ? PoissonSmall(lambda, random) : PoissonLarge(lambda, random);
